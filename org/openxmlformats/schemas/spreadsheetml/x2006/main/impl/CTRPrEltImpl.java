...
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1BList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1CharsetList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1ColorList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1CondenseList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1ExtendList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1FamilyList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1IList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1OutlineList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1RFontList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1SchemeList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1ShadowList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1StrikeList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1SzList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1UList;
import org.openxmlformats.schemas.spreadsheetml.x2006.main.impl.CTRPrEltImpl.1VertAlignList;
...
public class CTRPrEltImpl extends XmlComplexContentImpl implements CTRPrElt {
   ...
   public CTRPrEltImpl(SchemaType var1) {
      super(var1);
   }

   public List getRFontList() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return new 1RFontList(this);
      }
   }
   ...
   public CTFontName[] getRFontArray() {
      synchronized(this.monitor()) {
         ...
         this.get_store().find_all_element_users(RFONT$0, var2);
   ...
   public CTFontName getRFontArray(int var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTFontName)this.get_store().find_element_user(RFONT$0, var1);
         if(var3 == null) {
   ...
   public void setRFontArray(CTFontName[] var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.arraySetterHelper(var1, RFONT$0);
      }
   }
   ...
   public void setRFontArray(int var1, CTFontName var2) {
      synchronized(this.monitor()) {
         ...
         var4 = (CTFontName)this.get_store().find_element_user(RFONT$0, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTFontName insertNewRFont(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTFontName var3 = null;
         var3 = (CTFontName)this.get_store().insert_element_user(RFONT$0, var1);
         return var3;
      }
   }
   ...
   public CTFontName addNewRFont() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTFontName)this.get_store().add_element_user(RFONT$0);
         return var2;
      }
   }
   ...
   public void removeRFont(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(RFONT$0, var1);
      }
   }
