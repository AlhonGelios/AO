...
public interface STOrientation extends XmlString {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(STOrientation.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("storientation3c9ftype");
   STOrientation.Enum DEFAULT = STOrientation.Enum.forString("default");
   STOrientation.Enum PORTRAIT = STOrientation.Enum.forString("portrait");
   STOrientation.Enum LANDSCAPE = STOrientation.Enum.forString("landscape");
   int INT_DEFAULT = 1;
   int INT_PORTRAIT = 2;
   int INT_LANDSCAPE = 3;
   ...
   public static final class Enum extends StringEnumAbstractBase {
      ...
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new STOrientation.Enum[]{new STOrientation.Enum("default", 1), new STOrientation.Enum("portrait", 2), new STOrientation.Enum("landscape", 3)});
