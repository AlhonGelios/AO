...
public interface CTFont extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTFont.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctfont14d8type");
   ...
   CTFontName getNameArray(int var1);

   int sizeOfNameArray();

   void setNameArray(CTFontName[] var1);

   void setNameArray(int var1, CTFontName var2);

   CTFontName insertNewName(int var1);
   ...
   public static final class Factory {
      ...
      public static CTFont newInstance() {
         return (CTFont)POIXMLTypeLoader.newInstance(CTFont.type, (XmlOptions)null);
      }

      public static CTFont newInstance(XmlOptions var0) {
         return (CTFont)POIXMLTypeLoader.newInstance(CTFont.type, var0);
      }

      public static CTFont parse(String var0) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(String var0, XmlOptions var1) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(File var0) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(URL var0) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(InputStream var0) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(Reader var0) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(XMLStreamReader var0) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(Node var0) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static CTFont parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, (XmlOptions)null);
      }

      public static CTFont parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTFont)POIXMLTypeLoader.parse(var0, CTFont.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTFont.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTFont.type, var1);
      }
