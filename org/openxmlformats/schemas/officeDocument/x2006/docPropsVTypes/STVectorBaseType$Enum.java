...
public final class STVectorBaseType$Enum extends StringEnumAbstractBase {
   ...
   public static STVectorBaseType$Enum forString(String var0) {
      return (STVectorBaseType$Enum)table.forString(var0);
   }

   public static STVectorBaseType$Enum forInt(int var0) {
      return (STVectorBaseType$Enum)table.forInt(var0);
   }

   private STVectorBaseType$Enum(String var1, int var2) {
      super(var1, var2);
   }
