...
public interface CTVariant extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTVariant.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctvariantedcatype");
   ...
   void setVariant(CTVariant var1);
   ...
   public static final class Factory {
      ...
      public static CTVariant newInstance() {
         return (CTVariant)POIXMLTypeLoader.newInstance(CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant newInstance(XmlOptions var0) {
         return (CTVariant)POIXMLTypeLoader.newInstance(CTVariant.type, var0);
      }

      public static CTVariant parse(String var0) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(String var0, XmlOptions var1) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(File var0) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(URL var0) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(InputStream var0) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(Reader var0) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(XMLStreamReader var0) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(Node var0) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static CTVariant parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, (XmlOptions)null);
      }

      public static CTVariant parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTVariant)POIXMLTypeLoader.parse(var0, CTVariant.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTVariant.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTVariant.type, var1);
      }
