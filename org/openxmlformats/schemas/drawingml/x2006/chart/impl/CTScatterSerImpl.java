...
import org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTScatterSerImpl.1DPtList;
import org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTScatterSerImpl.1ErrBarsList;
import org.openxmlformats.schemas.drawingml.x2006.chart.impl.CTScatterSerImpl.1TrendlineList;
...
public class CTScatterSerImpl extends XmlComplexContentImpl implements CTScatterSer {
   ...
   public CTScatterSerImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public List getErrBarsList() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return new 1ErrBarsList(this);
      }
   }
   ...
   public CTErrBars[] getErrBarsArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ArrayList var2 = new ArrayList();
         this.get_store().find_all_element_users(ERRBARS$16, var2);
         CTErrBars[] var3 = new CTErrBars[var2.size()];
         var2.toArray(var3);
         return var3;
      }
   }
   ...
   public CTErrBars getErrBarsArray(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTErrBars var3 = null;
         var3 = (CTErrBars)this.get_store().find_element_user(ERRBARS$16, var1);
         if(var3 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return var3;
   ...
   public void setErrBarsArray(CTErrBars[] var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.arraySetterHelper(var1, ERRBARS$16);
      }
   }
   ...
   public void setErrBarsArray(int var1, CTErrBars var2) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTErrBars var4 = null;
         var4 = (CTErrBars)this.get_store().find_element_user(ERRBARS$16, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTErrBars insertNewErrBars(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTErrBars var3 = null;
         var3 = (CTErrBars)this.get_store().insert_element_user(ERRBARS$16, var1);
         return var3;
      }
   }
   ...
   public void removeErrBars(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ERRBARS$16, var1);
      }
   }
   ...
   public CTAxDataSource getXVal() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTAxDataSource)this.get_store().find_element_user(XVAL$18, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public void setXVal(CTAxDataSource var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTAxDataSource)this.get_store().find_element_user(XVAL$18, 0);
         if(var3 == null) {
            var3 = (CTAxDataSource)this.get_store().add_element_user(XVAL$18);
         }
   ...
   public CTAxDataSource addNewXVal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTAxDataSource var2 = null;
         var2 = (CTAxDataSource)this.get_store().add_element_user(XVAL$18);
         return var2;
      }
   }
   ...
   public CTNumDataSource getYVal() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTNumDataSource)this.get_store().find_element_user(YVAL$20, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public void setYVal(CTNumDataSource var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTNumDataSource)this.get_store().find_element_user(YVAL$20, 0);
         if(var3 == null) {
            var3 = (CTNumDataSource)this.get_store().add_element_user(YVAL$20);
         }
   ...
   public CTNumDataSource addNewYVal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTNumDataSource var2 = null;
         var2 = (CTNumDataSource)this.get_store().add_element_user(YVAL$20);
         return var2;
      }
   }
