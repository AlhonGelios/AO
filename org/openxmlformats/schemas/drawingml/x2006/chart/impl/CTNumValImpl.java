...
public class CTNumValImpl extends XmlComplexContentImpl implements CTNumVal {
   ...
   public CTNumValImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public String getFormatCode() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue var2 = null;
         var2 = (SimpleValue)this.get_store().find_attribute_user(FORMATCODE$4);
         return var2 == null?null:var2.getStringValue();
      }
   }
   ...
   public STXstring xgetFormatCode() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STXstring var2 = null;
         var2 = (STXstring)this.get_store().find_attribute_user(FORMATCODE$4);
         return var2;
      }
   }
   ...
   public void setFormatCode(String var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue var3 = null;
         var3 = (SimpleValue)this.get_store().find_attribute_user(FORMATCODE$4);
         if(var3 == null) {
            var3 = (SimpleValue)this.get_store().add_attribute_user(FORMATCODE$4);
         }
   ...
   public void xsetFormatCode(STXstring var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STXstring var3 = null;
         var3 = (STXstring)this.get_store().find_attribute_user(FORMATCODE$4);
         if(var3 == null) {
            var3 = (STXstring)this.get_store().add_attribute_user(FORMATCODE$4);
         }
