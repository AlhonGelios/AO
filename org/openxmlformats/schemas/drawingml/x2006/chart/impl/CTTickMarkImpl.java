...
public class CTTickMarkImpl extends XmlComplexContentImpl implements CTTickMark {
   ...
   public CTTickMarkImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public STTickMark.Enum getVal() {
      synchronized(this.monitor()) {
         ...
         return var2 == null?null:(STTickMark.Enum)var2.getEnumValue();
      }
   }
   ...
   public STTickMark xgetVal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STTickMark var2 = null;
         var2 = (STTickMark)this.get_store().find_attribute_user(VAL$0);
         if(var2 == null) {
            var2 = (STTickMark)this.get_default_attribute_value(VAL$0);
         }
   ...
   public void xsetVal(STTickMark var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STTickMark var3 = null;
         var3 = (STTickMark)this.get_store().find_attribute_user(VAL$0);
         if(var3 == null) {
            var3 = (STTickMark)this.get_store().add_attribute_user(VAL$0);
         }
