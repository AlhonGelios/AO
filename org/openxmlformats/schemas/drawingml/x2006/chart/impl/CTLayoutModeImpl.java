...
public class CTLayoutModeImpl extends XmlComplexContentImpl implements CTLayoutMode {
   ...
   public CTLayoutModeImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public STLayoutMode.Enum getVal() {
      synchronized(this.monitor()) {
         ...
         return var2 == null?null:(STLayoutMode.Enum)var2.getEnumValue();
      }
   }
   ...
   public STLayoutMode xgetVal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STLayoutMode var2 = null;
         var2 = (STLayoutMode)this.get_store().find_attribute_user(VAL$0);
         if(var2 == null) {
            var2 = (STLayoutMode)this.get_default_attribute_value(VAL$0);
         }
   ...
   public void xsetVal(STLayoutMode var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STLayoutMode var3 = null;
         var3 = (STLayoutMode)this.get_store().find_attribute_user(VAL$0);
         if(var3 == null) {
            var3 = (STLayoutMode)this.get_store().add_attribute_user(VAL$0);
         }
