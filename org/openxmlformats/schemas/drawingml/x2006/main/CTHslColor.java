...
public interface CTHslColor extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTHslColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cthslcolora63dtype");
   ...
   void setHue2(int var1);

   void xsetHue2(STPositiveFixedAngle var1);

   int getSat2();

   STPercentage xgetSat2();

   void setSat2(int var1);

   void xsetSat2(STPercentage var1);

   int getLum2();

   STPercentage xgetLum2();

   void setLum2(int var1);

   void xsetLum2(STPercentage var1);


   public static final class Factory {

      public static CTHslColor newInstance() {
         return (CTHslColor)POIXMLTypeLoader.newInstance(CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor newInstance(XmlOptions var0) {
         return (CTHslColor)POIXMLTypeLoader.newInstance(CTHslColor.type, var0);
      }

      public static CTHslColor parse(String var0) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(String var0, XmlOptions var1) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(File var0) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(URL var0) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(InputStream var0) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(Reader var0) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(XMLStreamReader var0) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(Node var0) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static CTHslColor parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static CTHslColor parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTHslColor)POIXMLTypeLoader.parse(var0, CTHslColor.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTHslColor.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTHslColor.type, var1);
      }
