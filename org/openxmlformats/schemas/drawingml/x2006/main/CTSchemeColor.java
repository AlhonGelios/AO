...
public interface CTSchemeColor extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSchemeColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctschemecolor5feftype");
   ...
   void setVal(STSchemeColorVal.Enum var1);

   void xsetVal(STSchemeColorVal var1);


   public static final class Factory {

      public static CTSchemeColor newInstance() {
         return (CTSchemeColor)POIXMLTypeLoader.newInstance(CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor newInstance(XmlOptions var0) {
         return (CTSchemeColor)POIXMLTypeLoader.newInstance(CTSchemeColor.type, var0);
      }

      public static CTSchemeColor parse(String var0) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(String var0, XmlOptions var1) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(File var0) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(URL var0) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(InputStream var0) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(Reader var0) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(XMLStreamReader var0) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(Node var0) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static CTSchemeColor parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static CTSchemeColor parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTSchemeColor)POIXMLTypeLoader.parse(var0, CTSchemeColor.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSchemeColor.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSchemeColor.type, var1);
      }
