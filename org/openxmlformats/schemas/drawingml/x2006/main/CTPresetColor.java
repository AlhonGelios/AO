...
public interface CTPresetColor extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTPresetColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctpresetcolora675type");
   ...
   void setVal(STPresetColorVal.Enum var1);

   void xsetVal(STPresetColorVal var1);
   ...
   public static final class Factory {
      ...
      public static CTPresetColor newInstance() {
         return (CTPresetColor)POIXMLTypeLoader.newInstance(CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor newInstance(XmlOptions var0) {
         return (CTPresetColor)POIXMLTypeLoader.newInstance(CTPresetColor.type, var0);
      }

      public static CTPresetColor parse(String var0) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(String var0, XmlOptions var1) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(File var0) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(URL var0) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(InputStream var0) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(Reader var0) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(XMLStreamReader var0) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(Node var0) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static CTPresetColor parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static CTPresetColor parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTPresetColor)POIXMLTypeLoader.parse(var0, CTPresetColor.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTPresetColor.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTPresetColor.type, var1);
      }
