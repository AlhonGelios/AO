...
public interface CTSystemColor extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSystemColor.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsystemcolor4525type");
   ...
   void setVal(STSystemColorVal.Enum var1);

   void xsetVal(STSystemColorVal var1);
   ...
   void setLastClr(byte[] var1);

   void xsetLastClr(STHexBinary3 var1);
   ...
   public static final class Factory {
      ...
      public static CTSystemColor newInstance() {
         return (CTSystemColor)POIXMLTypeLoader.newInstance(CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor newInstance(XmlOptions var0) {
         return (CTSystemColor)POIXMLTypeLoader.newInstance(CTSystemColor.type, var0);
      }

      public static CTSystemColor parse(String var0) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(String var0, XmlOptions var1) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(File var0) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(URL var0) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(InputStream var0) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(Reader var0) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(XMLStreamReader var0) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(Node var0) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static CTSystemColor parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static CTSystemColor parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTSystemColor)POIXMLTypeLoader.parse(var0, CTSystemColor.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSystemColor.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSystemColor.type, var1);
      }
