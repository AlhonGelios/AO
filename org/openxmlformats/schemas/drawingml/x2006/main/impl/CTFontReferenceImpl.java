...
public class CTFontReferenceImpl extends XmlComplexContentImpl implements CTFontReference {
   ...
   public CTFontReferenceImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public STFontCollectionIndex.Enum getIdx() {
      synchronized(this.monitor()) {
         ...
         var2 = (SimpleValue)this.get_store().find_attribute_user(IDX$12);
         return var2 == null?null:(STFontCollectionIndex.Enum)var2.getEnumValue();
      }
   }
   ...
   public STFontCollectionIndex xgetIdx() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STFontCollectionIndex var2 = null;
         var2 = (STFontCollectionIndex)this.get_store().find_attribute_user(IDX$12);
         return var2;
      }
   }
   ...
   public void setIdx(STFontCollectionIndex.Enum var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (SimpleValue)this.get_store().find_attribute_user(IDX$12);
         if(var3 == null) {
            var3 = (SimpleValue)this.get_store().add_attribute_user(IDX$12);
         }
   ...
   public void xsetIdx(STFontCollectionIndex var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STFontCollectionIndex var3 = null;
         var3 = (STFontCollectionIndex)this.get_store().find_attribute_user(IDX$12);
         if(var3 == null) {
            var3 = (STFontCollectionIndex)this.get_store().add_attribute_user(IDX$12);
         }
