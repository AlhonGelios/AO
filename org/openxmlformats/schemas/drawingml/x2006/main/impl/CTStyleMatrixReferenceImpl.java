...
public class CTStyleMatrixReferenceImpl extends XmlComplexContentImpl implements CTStyleMatrixReference {
   ...
   public CTStyleMatrixReferenceImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public STStyleMatrixColumnIndex xgetIdx() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STStyleMatrixColumnIndex var2 = null;
         var2 = (STStyleMatrixColumnIndex)this.get_store().find_attribute_user(IDX$12);
         return var2;
      }
   }
   ...
   public void setIdx(long var1) {
      synchronized(this.monitor()) {
         ...
         var4 = (SimpleValue)this.get_store().find_attribute_user(IDX$12);
         if(var4 == null) {
            var4 = (SimpleValue)this.get_store().add_attribute_user(IDX$12);
         }
   ...
   public void xsetIdx(STStyleMatrixColumnIndex var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         STStyleMatrixColumnIndex var3 = null;
         var3 = (STStyleMatrixColumnIndex)this.get_store().find_attribute_user(IDX$12);
         if(var3 == null) {
            var3 = (STStyleMatrixColumnIndex)this.get_store().add_attribute_user(IDX$12);
         }
