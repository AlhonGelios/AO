...
public interface CTCommentList extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTCommentList.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctcommentlistf692type");
   ...
   CTComment getCmArray(int var1);

   int sizeOfCmArray();

   void setCmArray(CTComment[] var1);

   void setCmArray(int var1, CTComment var2);

   CTComment insertNewCm(int var1);

   CTComment addNewCm();

   void removeCm(int var1);
