...
public interface CTTc extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTTc.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cttc4019type");
   ...
   public static final class Factory {
      ...
      public static CTTc newInstance() {
         return (CTTc)POIXMLTypeLoader.newInstance(CTTc.type, (XmlOptions)null);
      }

      public static CTTc newInstance(XmlOptions var0) {
         return (CTTc)POIXMLTypeLoader.newInstance(CTTc.type, var0);
      }

      public static CTTc parse(String var0) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(String var0, XmlOptions var1) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(File var0) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(URL var0) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(InputStream var0) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(Reader var0) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(XMLStreamReader var0) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(Node var0) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static CTTc parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, (XmlOptions)null);
      }

      public static CTTc parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTTc)POIXMLTypeLoader.parse(var0, CTTc.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTTc.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTTc.type, var1);
      }
