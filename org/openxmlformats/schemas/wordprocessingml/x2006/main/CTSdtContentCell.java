...
public interface CTSdtContentCell extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSdtContentCell.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsdtcontentcellb170type");
   ...
   CTTc getTcArray(int var1);

   int sizeOfTcArray();

   void setTcArray(CTTc[] var1);

   void setTcArray(int var1, CTTc var2);

   CTTc insertNewTc(int var1);
   ...
   CTCustomXmlCell getCustomXmlArray(int var1);

   int sizeOfCustomXmlArray();

   void setCustomXmlArray(CTCustomXmlCell[] var1);

   void setCustomXmlArray(int var1, CTCustomXmlCell var2);

   CTCustomXmlCell insertNewCustomXml(int var1);
   ...
   CTSdtCell getSdtArray(int var1);

   int sizeOfSdtArray();

   void setSdtArray(CTSdtCell[] var1);

   void setSdtArray(int var1, CTSdtCell var2);

   CTSdtCell insertNewSdt(int var1);
   ...
   public static final class Factory {
      ...
      public static CTSdtContentCell newInstance() {
         return (CTSdtContentCell)POIXMLTypeLoader.newInstance(CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell newInstance(XmlOptions var0) {
         return (CTSdtContentCell)POIXMLTypeLoader.newInstance(CTSdtContentCell.type, var0);
      }

      public static CTSdtContentCell parse(String var0) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(String var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(File var0) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(URL var0) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(InputStream var0) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(Reader var0) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(XMLStreamReader var0) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(Node var0) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static CTSdtContentCell parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static CTSdtContentCell parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTSdtContentCell)POIXMLTypeLoader.parse(var0, CTSdtContentCell.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSdtContentCell.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSdtContentCell.type, var1);
      }
