...
public interface CTHyperlink extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTHyperlink.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cthyperlink38actype");
   ...
   void xsetTgtFrame(STString var1);
   ...
   void xsetTooltip(STString var1);
   ...
   void setDocLocation(String var1);

   void xsetDocLocation(STString var1);
   ...
   void setHistory(STOnOff.Enum var1);

   void xsetHistory(STOnOff var1);
   ...
   void setAnchor(String var1);

   void xsetAnchor(STString var1);
