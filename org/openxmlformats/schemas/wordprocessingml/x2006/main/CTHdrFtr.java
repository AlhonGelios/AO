...
public interface CTHdrFtr extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTHdrFtr.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cthdrftr26datype");
   ...
   public static final class Factory {
      ...
      public static CTHdrFtr newInstance() {
         return (CTHdrFtr)POIXMLTypeLoader.newInstance(CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr newInstance(XmlOptions var0) {
         return (CTHdrFtr)POIXMLTypeLoader.newInstance(CTHdrFtr.type, var0);
      }

      public static CTHdrFtr parse(String var0) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(String var0, XmlOptions var1) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(File var0) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(URL var0) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(InputStream var0) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(Reader var0) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(XMLStreamReader var0) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(Node var0) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static CTHdrFtr parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static CTHdrFtr parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTHdrFtr)POIXMLTypeLoader.parse(var0, CTHdrFtr.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTHdrFtr.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTHdrFtr.type, var1);
      }
