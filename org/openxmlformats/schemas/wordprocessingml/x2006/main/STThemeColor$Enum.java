...
public final class STThemeColor$Enum extends StringEnumAbstractBase {
   ...
   public static STThemeColor$Enum forString(String var0) {
      return (STThemeColor$Enum)table.forString(var0);
   }

   public static STThemeColor$Enum forInt(int var0) {
      return (STThemeColor$Enum)table.forInt(var0);
   }

   private STThemeColor$Enum(String var1, int var2) {
      super(var1, var2);
   }
