...
public interface CTTbl extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTTbl.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("cttblc014type");
   ...
   void setTblPr(CTTblPr var1);

   CTTblPr addNewTblPr();

   CTTblGrid getTblGrid();

   void setTblGrid(CTTblGrid var1);
   ...
   CTRow getTrArray(int var1);

   int sizeOfTrArray();

   void setTrArray(CTRow[] var1);

   void setTrArray(int var1, CTRow var2);

   CTRow insertNewTr(int var1);
   ...
   CTCustomXmlRow getCustomXmlArray(int var1);

   int sizeOfCustomXmlArray();

   void setCustomXmlArray(CTCustomXmlRow[] var1);

   void setCustomXmlArray(int var1, CTCustomXmlRow var2);

   CTCustomXmlRow insertNewCustomXml(int var1);
   ...
   CTSdtRow getSdtArray(int var1);

   int sizeOfSdtArray();

   void setSdtArray(CTSdtRow[] var1);

   void setSdtArray(int var1, CTSdtRow var2);

   CTSdtRow insertNewSdt(int var1);
   ...
   public static final class Factory {
      ...
      public static CTTbl newInstance() {
         return (CTTbl)POIXMLTypeLoader.newInstance(CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl newInstance(XmlOptions var0) {
         return (CTTbl)POIXMLTypeLoader.newInstance(CTTbl.type, var0);
      }

      public static CTTbl parse(String var0) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(String var0, XmlOptions var1) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(File var0) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(URL var0) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(InputStream var0) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(Reader var0) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(XMLStreamReader var0) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(Node var0) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static CTTbl parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, (XmlOptions)null);
      }

      public static CTTbl parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTTbl)POIXMLTypeLoader.parse(var0, CTTbl.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTTbl.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTTbl.type, var1);
      }
