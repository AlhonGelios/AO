...
public interface CTP extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTP.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctpa1e2type");
   ...
   void setRsidP(byte[] var1);

   void xsetRsidP(STLongHexNumber var1);
   ...
   void setRsidRDefault(byte[] var1);

   void xsetRsidRDefault(STLongHexNumber var1);
   ...
   public static final class Factory {
      ...
      public static CTP newInstance() {
         return (CTP)POIXMLTypeLoader.newInstance(CTP.type, (XmlOptions)null);
      }

      public static CTP newInstance(XmlOptions var0) {
         return (CTP)POIXMLTypeLoader.newInstance(CTP.type, var0);
      }

      public static CTP parse(String var0) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(String var0, XmlOptions var1) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(File var0) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(URL var0) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(InputStream var0) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(Reader var0) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(XMLStreamReader var0) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(Node var0) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static CTP parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, (XmlOptions)null);
      }

      public static CTP parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTP)POIXMLTypeLoader.parse(var0, CTP.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTP.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTP.type, var1);
      }
