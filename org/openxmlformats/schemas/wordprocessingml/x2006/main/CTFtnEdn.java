...
public interface CTFtnEdn extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTFtnEdn.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctftnedncad9type");
   ...
   void setType(STFtnEdn.Enum var1);

   void xsetType(STFtnEdn var1);
   ...
   public static final class Factory {
      ...
      public static CTFtnEdn newInstance() {
         return (CTFtnEdn)POIXMLTypeLoader.newInstance(CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn newInstance(XmlOptions var0) {
         return (CTFtnEdn)POIXMLTypeLoader.newInstance(CTFtnEdn.type, var0);
      }

      public static CTFtnEdn parse(String var0) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(String var0, XmlOptions var1) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(File var0) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(URL var0) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(InputStream var0) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(Reader var0) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(XMLStreamReader var0) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(Node var0) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static CTFtnEdn parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static CTFtnEdn parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTFtnEdn)POIXMLTypeLoader.parse(var0, CTFtnEdn.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTFtnEdn.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTFtnEdn.type, var1);
      }
