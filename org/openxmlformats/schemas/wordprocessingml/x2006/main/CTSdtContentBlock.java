...
public interface CTSdtContentBlock extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTSdtContentBlock.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctsdtcontentblockb37btype");
   ...
   public static final class Factory {
      ...
      public static CTSdtContentBlock newInstance() {
         return (CTSdtContentBlock)POIXMLTypeLoader.newInstance(CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock newInstance(XmlOptions var0) {
         return (CTSdtContentBlock)POIXMLTypeLoader.newInstance(CTSdtContentBlock.type, var0);
      }

      public static CTSdtContentBlock parse(String var0) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(String var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(File var0) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(File var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(URL var0) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(URL var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(InputStream var0) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(InputStream var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(Reader var0) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(Reader var0, XmlOptions var1) throws XmlException, IOException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(XMLStreamReader var0) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(XMLStreamReader var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(Node var0) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(Node var0, XmlOptions var1) throws XmlException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static CTSdtContentBlock parse(XMLInputStream var0) throws XmlException, XMLStreamException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static CTSdtContentBlock parse(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return (CTSdtContentBlock)POIXMLTypeLoader.parse(var0, CTSdtContentBlock.type, var1);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSdtContentBlock.type, (XmlOptions)null);
      }

      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream var0, XmlOptions var1) throws XmlException, XMLStreamException {
         return POIXMLTypeLoader.newValidatingXMLInputStream(var0, CTSdtContentBlock.type, var1);
      }
