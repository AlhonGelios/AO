...
public interface CTComment extends CTTrackChange {

   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTComment.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctcomment6a93type");
   ...
   STString xgetInitials();

   boolean isSetInitials();

   void setInitials(String var1);

   void xsetInitials(STString var1);
