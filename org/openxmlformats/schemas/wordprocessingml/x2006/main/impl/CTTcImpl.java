...
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1AltChunkList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1BookmarkEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1BookmarkStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CommentRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CommentRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlDelRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlDelRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlInsRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlInsRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlMoveFromRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlMoveFromRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlMoveToRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1CustomXmlMoveToRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1DelList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1InsList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveFromList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveFromRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveFromRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveToList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveToRangeEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1MoveToRangeStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1OMathList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1OMathParaList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1PList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1PermEndList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1PermStartList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1ProofErrList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1SdtList;
import org.openxmlformats.schemas.wordprocessingml.x2006.main.impl.CTTcImpl.1TblList;
...
public class CTTcImpl extends XmlComplexContentImpl implements CTTc {
   ...
   public CTTcImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public CTTcPr getTcPr() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTcPr var2 = null;
         var2 = (CTTcPr)this.get_store().find_element_user(TCPR$0, 0);
   ...
   public void setTcPr(CTTcPr var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTcPr var3 = null;
         var3 = (CTTcPr)this.get_store().find_element_user(TCPR$0, 0);
         if(var3 == null) {
            var3 = (CTTcPr)this.get_store().add_element_user(TCPR$0);
         }
   ...
   public CTTcPr addNewTcPr() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTcPr var2 = null;
         var2 = (CTTcPr)this.get_store().add_element_user(TCPR$0);
         return var2;
      }
   }
   ...
   public CTCustomXmlBlock getCustomXmlArray(int var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTCustomXmlBlock)this.get_store().find_element_user(CUSTOMXML$2, var1);
         if(var3 == null) {
   ...
   public void setCustomXmlArray(int var1, CTCustomXmlBlock var2) {
      synchronized(this.monitor()) {
         ...
         var4 = (CTCustomXmlBlock)this.get_store().find_element_user(CUSTOMXML$2, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTCustomXmlBlock insertNewCustomXml(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTCustomXmlBlock var3 = null;
         var3 = (CTCustomXmlBlock)this.get_store().insert_element_user(CUSTOMXML$2, var1);
         return var3;
      }
   }
   ...
   public CTCustomXmlBlock addNewCustomXml() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTCustomXmlBlock)this.get_store().add_element_user(CUSTOMXML$2);
         return var2;
      }
   }
   ...
   public CTSdtBlock getSdtArray(int var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTSdtBlock)this.get_store().find_element_user(SDT$4, var1);
         if(var3 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return var3;
   ...
   public void setSdtArray(int var1, CTSdtBlock var2) {
      synchronized(this.monitor()) {
         ...
         var4 = (CTSdtBlock)this.get_store().find_element_user(SDT$4, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTSdtBlock insertNewSdt(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtBlock var3 = null;
         var3 = (CTSdtBlock)this.get_store().insert_element_user(SDT$4, var1);
         return var3;
      }
   }
   ...
   public CTSdtBlock addNewSdt() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTSdtBlock)this.get_store().add_element_user(SDT$4);
         return var2;
      }
   }
   ...
   public CTP[] getPArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ArrayList var2 = new ArrayList();
         this.get_store().find_all_element_users(P$6, var2);
   ...
   public CTP getPArray(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTP var3 = null;
         var3 = (CTP)this.get_store().find_element_user(P$6, var1);
         if(var3 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return var3;
   ...
   public void setPArray(CTP[] var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.arraySetterHelper(var1, P$6);
      }
   }
   ...
   public void setPArray(int var1, CTP var2) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTP var4 = null;
         var4 = (CTP)this.get_store().find_element_user(P$6, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTP insertNewP(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTP var3 = null;
         var3 = (CTP)this.get_store().insert_element_user(P$6, var1);
         return var3;
      }
   }
   ...
   public CTP addNewP() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTP var2 = null;
         var2 = (CTP)this.get_store().add_element_user(P$6);
         return var2;
      }
   }
   ...
   public void removeP(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(P$6, var1);
      }
   }
   ...
   public CTTbl[] getTblArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ArrayList var2 = new ArrayList();
         this.get_store().find_all_element_users(TBL$8, var2);
   ...
   public CTTbl getTblArray(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTbl var3 = null;
         var3 = (CTTbl)this.get_store().find_element_user(TBL$8, var1);
         if(var3 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return var3;
   ...
   public void setTblArray(CTTbl[] var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.arraySetterHelper(var1, TBL$8);
      }
   }
   ...
   public void setTblArray(int var1, CTTbl var2) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTbl var4 = null;
         var4 = (CTTbl)this.get_store().find_element_user(TBL$8, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTTbl insertNewTbl(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTbl var3 = null;
         var3 = (CTTbl)this.get_store().insert_element_user(TBL$8, var1);
         return var3;
      }
   }
   ...
   public CTTbl addNewTbl() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTTbl var2 = null;
         var2 = (CTTbl)this.get_store().add_element_user(TBL$8);
         return var2;
      }
   }
   ...
   public void removeTbl(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(TBL$8, var1);
      }
   }
   ...
   public CTAltChunk[] getAltChunkArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ArrayList var2 = new ArrayList();
         this.get_store().find_all_element_users(ALTCHUNK$60, var2);
   ...
   public CTAltChunk getAltChunkArray(int var1) {
      synchronized(this.monitor()) {
         ...
         var3 = (CTAltChunk)this.get_store().find_element_user(ALTCHUNK$60, var1);
         if(var3 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return var3;
   ...
   public void setAltChunkArray(CTAltChunk[] var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.arraySetterHelper(var1, ALTCHUNK$60);
      }
   }
   ...
   public void setAltChunkArray(int var1, CTAltChunk var2) {
      synchronized(this.monitor()) {
         ...
         var4 = (CTAltChunk)this.get_store().find_element_user(ALTCHUNK$60, var1);
         if(var4 == null) {
            throw new IndexOutOfBoundsException();
         } else {
            var4.set(var2);
   ...
   public CTAltChunk insertNewAltChunk(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTAltChunk var3 = null;
         var3 = (CTAltChunk)this.get_store().insert_element_user(ALTCHUNK$60, var1);
         return var3;
      }
   }
   ...
   public CTAltChunk addNewAltChunk() {
      synchronized(this.monitor()) {
         ...
         var2 = (CTAltChunk)this.get_store().add_element_user(ALTCHUNK$60);
         return var2;
      }
   }
   ...
   public void removeAltChunk(int var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ALTCHUNK$60, var1);
      }
   }
