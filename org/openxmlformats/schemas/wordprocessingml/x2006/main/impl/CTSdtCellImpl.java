...
public class CTSdtCellImpl extends XmlComplexContentImpl implements CTSdtCell {
   ...
   public CTSdtCellImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public CTSdtContentCell getSdtContent() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentCell var2 = null;
         var2 = (CTSdtContentCell)this.get_store().find_element_user(SDTCONTENT$4, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public void setSdtContent(CTSdtContentCell var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentCell var3 = null;
         var3 = (CTSdtContentCell)this.get_store().find_element_user(SDTCONTENT$4, 0);
         if(var3 == null) {
            var3 = (CTSdtContentCell)this.get_store().add_element_user(SDTCONTENT$4);
         }
   ...
   public CTSdtContentCell addNewSdtContent() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentCell var2 = null;
         var2 = (CTSdtContentCell)this.get_store().add_element_user(SDTCONTENT$4);
         return var2;
      }
   }
