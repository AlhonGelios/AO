...
public class CTTcBordersImpl extends XmlComplexContentImpl implements CTTcBorders {
   ...
   public CTTcBordersImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public CTBorder getTl2Br() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var2 = null;
         var2 = (CTBorder)this.get_store().find_element_user(TL2BR$12, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public boolean isSetTl2Br() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(TL2BR$12) != 0;
      }
   }
   ...
   public void setTl2Br(CTBorder var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var3 = null;
         var3 = (CTBorder)this.get_store().find_element_user(TL2BR$12, 0);
         if(var3 == null) {
            var3 = (CTBorder)this.get_store().add_element_user(TL2BR$12);
         }
   ...
   public CTBorder addNewTl2Br() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var2 = null;
         var2 = (CTBorder)this.get_store().add_element_user(TL2BR$12);
         return var2;
      }
   }
   ...
   public void unsetTl2Br() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(TL2BR$12, 0);
      }
   }
   ...
   public CTBorder getTr2Bl() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var2 = null;
         var2 = (CTBorder)this.get_store().find_element_user(TR2BL$14, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public boolean isSetTr2Bl() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(TR2BL$14) != 0;
      }
   }
   ...
   public void setTr2Bl(CTBorder var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var3 = null;
         var3 = (CTBorder)this.get_store().find_element_user(TR2BL$14, 0);
         if(var3 == null) {
            var3 = (CTBorder)this.get_store().add_element_user(TR2BL$14);
         }
   ...
   public CTBorder addNewTr2Bl() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTBorder var2 = null;
         var2 = (CTBorder)this.get_store().add_element_user(TR2BL$14);
         return var2;
      }
   }
   ...
   public void unsetTr2Bl() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(TR2BL$14, 0);
      }
   }
