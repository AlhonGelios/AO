...
public class CTSdtRunImpl extends XmlComplexContentImpl implements CTSdtRun {
   ...
   public CTSdtRunImpl(SchemaType var1) {
      super(var1);
   }
   ...
   public CTSdtContentRun getSdtContent() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentRun var2 = null;
         var2 = (CTSdtContentRun)this.get_store().find_element_user(SDTCONTENT$4, 0);
         return var2 == null?null:var2;
      }
   }
   ...
   public void setSdtContent(CTSdtContentRun var1) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentRun var3 = null;
         var3 = (CTSdtContentRun)this.get_store().find_element_user(SDTCONTENT$4, 0);
         if(var3 == null) {
            var3 = (CTSdtContentRun)this.get_store().add_element_user(SDTCONTENT$4);
         }
   ...
   public CTSdtContentRun addNewSdtContent() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         CTSdtContentRun var2 = null;
         var2 = (CTSdtContentRun)this.get_store().add_element_user(SDTCONTENT$4);
         return var2;
      }
   }
