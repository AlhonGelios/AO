...
public final class CellValue {
   ...
   public CellValue(double numberValue) {
      this(CellType.NUMERIC, numberValue, false, (String)null, 0);
   }
   ...
   public static CellValue getError(int errorCode) {
      return new CellValue(CellType.ERROR, 0.0D, false, (String)null, errorCode);
   }
   ...
   public String formatAsString() {
      switch(CellValue.NamelessClass1873957734.$SwitchMap$org$apache$poi$ss$usermodel$CellType[this._cellType.ordinal()]) {
      case 1:
   ...
   // $FF: synthetic class
   static class NamelessClass1873957734 {
