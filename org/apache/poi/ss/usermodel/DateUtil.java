...
public class DateUtil {
   ...
   private static ThreadLocal lastFormatIndex = new ThreadLocal() {
      ...
      if(isInternalDateFormat(formatIndex)) {
         ...
         if(isCached(formatString, formatIndex)) {
            ...
            for(separatorIndex = 0; separatorIndex < length; ++separatorIndex) {
               char result = fs.charAt(separatorIndex);
            ...
            if(date_ptrn4.matcher(fs).matches()) {
               ...
               if(!date_ptrn3a.matcher(fs).find()) {
                  ...
                  boolean var8 = date_ptrn3b.matcher(fs).matches();
                  cache(formatString, formatIndex, var8);
                  return var8;
               }
            }
         }
