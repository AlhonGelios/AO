...
public final class EscherBSERecord extends EscherRecord {
   ...
   public int serialize(int offset, byte[] data, EscherSerializationListener listener) {
      ...
      int bytesWritten;
      for(bytesWritten = 0; bytesWritten < 16; ++bytesWritten) {
         data[offset + 10 + bytesWritten] = this.field_3_uid[bytesWritten];
      }
   ...
   public String toString() {
      String extraData = this._remainingData == null?null:HexDump.toHex(this._remainingData, 32);
