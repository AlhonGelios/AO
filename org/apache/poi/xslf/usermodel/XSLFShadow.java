...
public class XSLFShadow extends XSLFShape implements Shadow {
   ...
   public double getDistance() {
      ...
      return ct.isSetDist()?Units.toPoints(ct.getDist()):0.0D;
   }

   public double getAngle() {
      CTOuterShadowEffect ct = (CTOuterShadowEffect)this.getXmlObject();
      return ct.isSetDir()?(double)ct.getDir() / 60000.0D:0.0D;
   }

   public double getBlur() {
      CTOuterShadowEffect ct = (CTOuterShadowEffect)this.getXmlObject();
      return ct.isSetBlurRad()?Units.toPoints(ct.getBlurRad()):0.0D;
   }
