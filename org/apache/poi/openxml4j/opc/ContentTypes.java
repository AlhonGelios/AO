...
public final class ContentTypes {
   ...
   public static String getContentTypeFromFileExtension(String filename) {
      ...
      return !extension.equals("jpg") && !extension.equals("jpeg")?(extension.equals("gif")?"image/gif":(extension.equals("tiff")?"image/pict":(extension.equals("png")?"image/png":(extension.equals("tiff")?"image/tiff":(extension.equals("xml")?"text/xml":null))))):"image/jpeg";
   }
}
