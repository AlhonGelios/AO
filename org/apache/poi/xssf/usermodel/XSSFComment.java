...
public class XSSFComment implements Comment {
   ...
   public String getAuthor() {
      return this._comments.getAuthor((long)((int)this._comment.getAuthorId()));
   }
   ...
   public ClientAnchor getClientAnchor() {
      ...
      XSSFClientAnchor var8 = new XSSFClientAnchor(pos[1] * 9525, pos[3] * 9525, pos[5] * 9525, pos[7] * 9525, pos[0], pos[2], pos[4], pos[6]);
      return var8;
   }
