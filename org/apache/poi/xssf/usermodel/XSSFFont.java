...
public class XSSFFont implements Font {
   ...
   public short getColor() {
      ...
      if(color == null) {
         ...
         return index == (long)DEFAULT_FONT_COLOR?IndexedColors.BLACK.getIndex():(index == (long)IndexedColors.RED.getIndex()?IndexedColors.RED.getIndex():(short)((int)index));
      }
   }
   ...
   public short getFontHeight() {
      return (short)((int)(this.getFontHeightRaw() * 20.0D));
   }

   public short getFontHeightInPoints() {
      return (short)((int)this.getFontHeightRaw());
   }
