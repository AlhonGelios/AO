...
public class XDGFConnection {
   ...
   public Integer getFromPart() {
      return this._connect.isSetFromPart()?Integer.valueOf(this._connect.getFromPart()):null;
   }

   public Integer getToPart() {
      return this._connect.isSetToPart()?Integer.valueOf(this._connect.getToPart()):null;
   }
}
