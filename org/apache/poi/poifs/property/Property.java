...
public abstract class Property implements Child, POIFSViewable {
   ...
   public Object[] getViewableArray() {
      Object[] results = new Object[]{"Name          = \"" + this.getName() + "\"", "Property Type = " + this._property_type.get(), "Node Color    = " + this._node_color.get(), null, null};
      long time = (long)this._days_1.get();
      time <<= 32;
      time += (long)this._seconds_1.get() & 65535L;
      results[3] = "Time 1        = " + time;
      time = (long)this._days_2.get();
      time <<= 32;
      time += (long)this._seconds_2.get() & 65535L;
