   ...
   private HeaderBlock(byte[] data) throws IOException {
      ...
      if(signature != -2226271756974174256L) {
         if(cmp(POIFSConstants.OOXML_FILE_HEADER, data)) {
            ...
            throw new NotOLE2FileException("Invalid header signature; read " + HexDump.longToHex(signature) + ", expected " + HexDump.longToHex(-2226271756974174256L) + " - Your file appears " + "not to be a valid OLE2 document");
         } else {
