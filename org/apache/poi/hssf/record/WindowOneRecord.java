...
public final class WindowOneRecord extends StandardRecord {
   ...
   public String toString() {
      ...
      buffer.append("    .activeSheet     = ").append(Integer.toHexString(this.getActiveSheetIndex())).append("\n");
      buffer.append("    .firstVisibleTab    = ").append(Integer.toHexString(this.getFirstVisibleTab())).append("\n");
