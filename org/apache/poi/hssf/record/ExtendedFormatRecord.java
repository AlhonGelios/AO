...
public final class ExtendedFormatRecord extends StandardRecord {
   ...
   private static final BitField _parent_index = BitFieldFactory.getInstance('\ufff0');
   ...
   private static final BitField _rotation = BitFieldFactory.getInstance('\uff00');
   ...
   private static final BitField _indent_not_parent_cell_options = BitFieldFactory.getInstance('\u8000');
   ...
   private static final BitField _border_bottom = BitFieldFactory.getInstance('\uf000');
   ...
   private static final BitField _diag = BitFieldFactory.getInstance('\uc000');
   ...
   public int hashCode() {
      boolean prime = true;
      byte result = 1;
      int result1 = 31 * result + this.field_1_font_index;
      result1 = 31 * result1 + this.field_2_format_index;
      result1 = 31 * result1 + this.field_3_cell_options;
      result1 = 31 * result1 + this.field_4_alignment_options;
      result1 = 31 * result1 + this.field_5_indention_options;
      result1 = 31 * result1 + this.field_6_border_options;
      result1 = 31 * result1 + this.field_7_palette_options;
      result1 = 31 * result1 + this.field_8_adtl_palette_options;
      result1 = 31 * result1 + this.field_9_fill_palette_options;
      return result1;
   }
   ...
   public boolean equals(Object obj) {
      if(this == obj) {
         ...
         return false;
      } else if(obj instanceof ExtendedFormatRecord) {
         ExtendedFormatRecord other = (ExtendedFormatRecord)obj;
         return this.field_1_font_index != other.field_1_font_index?false:(this.field_2_format_index != other.field_2_format_index?false:(this.field_3_cell_options != other.field_3_cell_options?false:(this.field_4_alignment_options != other.field_4_alignment_options?false:(this.field_5_indention_options != other.field_5_indention_options?false:(this.field_6_border_options != other.field_6_border_options?false:(this.field_7_palette_options != other.field_7_palette_options?false:(this.field_8_adtl_palette_options != other.field_8_adtl_palette_options?false:this.field_9_fill_palette_options == other.field_9_fill_palette_options)))))));
      } else {
         return false;
      }
   }
