...
public interface XmlUnsignedInt extends XmlUnsignedLong {
   ...
   public static final class Factory {
      ...
      public static XmlUnsignedInt parse(String s) throws XmlException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(s, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(File f) throws XmlException, IOException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(f, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(URL u) throws XmlException, IOException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(u, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(InputStream is) throws XmlException, IOException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(is, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(Reader r) throws XmlException, IOException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(r, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(xis, XmlUnsignedInt.type, (XmlOptions)null);
      }
      ...
      public static XmlUnsignedInt parse(XMLStreamReader xsr) throws XmlException {
         return (XmlUnsignedInt)XmlBeans.getContextTypeLoader().parse(xsr, XmlUnsignedInt.type, (XmlOptions)null);
      }
