...
public interface XmlDecimal extends XmlAnySimpleType {
   ...
   public static final class Factory {
      ...
      public static XmlDecimal parse(String s) throws XmlException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(s, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(File f) throws XmlException, IOException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(f, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(URL u) throws XmlException, IOException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(u, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(InputStream is) throws XmlException, IOException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(is, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(Reader r) throws XmlException, IOException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(r, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(xis, XmlDecimal.type, (XmlOptions)null);
      }
      ...
      public static XmlDecimal parse(XMLStreamReader xsr) throws XmlException {
         return (XmlDecimal)XmlBeans.getContextTypeLoader().parse(xsr, XmlDecimal.type, (XmlOptions)null);
      }
