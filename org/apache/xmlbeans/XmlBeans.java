...
public final class XmlBeans {
   ...
   public static XmlCursor nodeToCursor(Node n) {
      try {
         return (XmlCursor)_nodeToCursorMethod.invoke((Object)null, new Object[]{n});
   ...
   public static XmlObject nodeToXmlObject(Node n) {
      try {
         return (XmlObject)_nodeToXmlObjectMethod.invoke((Object)null, new Object[]{n});
      } catch (IllegalAccessException var4) {
   ...
   public static XMLStreamReader nodeToXmlStreamReader(Node n) {
      try {
         return (XMLStreamReader)_nodeToXmlStreamMethod.invoke((Object)null, new Object[]{n});
      } catch (IllegalAccessException var4) {
   ...
   public static Node streamToNode(XMLStreamReader xs) {
      try {
         return (Node)_streamToNodeMethod.invoke((Object)null, new Object[]{xs});
      } catch (IllegalAccessException var4) {
   ...
   public static SchemaTypeLoader loadXsd(XmlObject[] schemas, XmlOptions options) throws XmlException {
      try {
         SchemaTypeSystem e = (SchemaTypeSystem)_compilationMethod.invoke((Object)null, new Object[]{null, null, schemas, null, getContextTypeLoader(), null, options});
         return e == null?null:typeLoaderUnion(new SchemaTypeLoader[]{e, getContextTypeLoader()});
      } catch (IllegalAccessException var3) {
   ...
   public static SchemaTypeSystem compileXmlBeans(String name, SchemaTypeSystem system, XmlObject[] schemas, BindingConfig config, SchemaTypeLoader typepath, Filer filer, XmlOptions options) throws XmlException {
      try {
         return (SchemaTypeSystem)_compilationMethod.invoke((Object)null, new Object[]{name, system, schemas, config, typepath != null?typepath:getContextTypeLoader(), filer, options});
   ...
   public static SchemaTypeLoader typeLoaderUnion(SchemaTypeLoader[] typeLoaders) {
      try {
         return typeLoaders.length == 1?typeLoaders[0]:(SchemaTypeLoader)_typeLoaderBuilderMethod.invoke((Object)null, new Object[]{typeLoaders, null, null});
      } catch (IllegalAccessException var4) {
   ...
   public static SchemaTypeLoader typeLoaderForClassLoader(ClassLoader loader) {
      try {
         return (SchemaTypeLoader)_typeLoaderBuilderMethod.invoke((Object)null, new Object[]{null, null, loader});
      } catch (IllegalAccessException var4) {
         throw causedException(new IllegalStateException("No access to SchemaTypeLoaderImpl: verify that version of xbean.jar is correct"), var4);
      } catch (InvocationTargetException var5) {
         Throwable t = var5.getCause();
   ...
   public static SchemaTypeLoader typeLoaderForResource(ResourceLoader resourceLoader) {
      try {
         return (SchemaTypeLoader)_typeLoaderBuilderMethod.invoke((Object)null, new Object[]{null, resourceLoader, null});
      } catch (IllegalAccessException var4) {
         throw causedException(new IllegalStateException("No access to SchemaTypeLoaderImpl: verify that version of xbean.jar is correct"), var4);
      } catch (InvocationTargetException var5) {
         Throwable t = var5.getCause();
   ...
   public static SchemaTypeSystem typeSystemForClassLoader(ClassLoader loader, String stsName) {
      try {
         Class e = loader.loadClass(stsName + "." + "TypeSystemHolder");
         SchemaTypeSystem sts = (SchemaTypeSystem)((SchemaTypeSystem)e.getDeclaredField("typeSystem").get((Object)null));
         if(sts == null) {
   ...
   public static SchemaType typeForClass(Class c) {
      if(c != null && XmlObject.class.isAssignableFrom(c)) {
         try {
            Field e = c.getField("type");
            return e == null?null:(SchemaType)e.get((Object)null);
