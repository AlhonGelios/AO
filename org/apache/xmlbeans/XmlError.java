...
public class XmlError implements Serializable {
   ...
   public static String formattedMessage(String code, Object[] args) {
      if(code == null) {
         ...
         try {
            ...
            return MessageFormat.format(_bundle.getString("message.missing.resource"), new Object[]{var4.getMessage()});
         } catch (IllegalArgumentException var5) {
            return MessageFormat.format(_bundle.getString("message.pattern.invalid"), new Object[]{var5.getMessage()});
         }
      }
   }
   ...
   public Object getLocation(Object type) {
      return type == XmlCursor.class?this._cursor:(type == XmlObject.class && this._cursor != null?this._cursor.getObject():null);
   }
   ...
   public String toString(URI base) {
      ...
      sb.append(msg1 == null?"<Unspecified message>":msg1);
      return sb.toString();
   }
