...
public interface XmlCursor extends XmlTokenSource {
   ...
   boolean toBookmark(XmlCursor.XmlBookmark var1);

   XmlCursor.XmlBookmark toNextBookmark(Object var1);

   XmlCursor.XmlBookmark toPrevBookmark(Object var1);
   ...
   XmlCursor.TokenType toNextToken();

   XmlCursor.TokenType toPrevToken();

   XmlCursor.TokenType toFirstContentToken();

   XmlCursor.TokenType toEndToken();
   ...
   XmlCursor.ChangeStamp getDocChangeStamp();

   void setBookmark(XmlCursor.XmlBookmark var1);

   XmlCursor.XmlBookmark getBookmark(Object var1);
   ...
   public static final class TokenType {
      ...
      public static final XmlCursor.TokenType NONE = new XmlCursor.TokenType("NONE", 0);
      public static final XmlCursor.TokenType STARTDOC = new XmlCursor.TokenType("STARTDOC", 1);
      public static final XmlCursor.TokenType ENDDOC = new XmlCursor.TokenType("ENDDOC", 2);
      public static final XmlCursor.TokenType START = new XmlCursor.TokenType("START", 3);
      public static final XmlCursor.TokenType END = new XmlCursor.TokenType("END", 4);
      public static final XmlCursor.TokenType TEXT = new XmlCursor.TokenType("TEXT", 5);
      public static final XmlCursor.TokenType ATTR = new XmlCursor.TokenType("ATTR", 6);
      public static final XmlCursor.TokenType NAMESPACE = new XmlCursor.TokenType("NAMESPACE", 7);
      public static final XmlCursor.TokenType COMMENT = new XmlCursor.TokenType("COMMENT", 8);
      public static final XmlCursor.TokenType PROCINST = new XmlCursor.TokenType("PROCINST", 9);
