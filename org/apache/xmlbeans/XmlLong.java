...
public interface XmlLong extends XmlInteger {
   ...
   public static final class Factory {
      ...
      public static XmlLong parse(String s) throws XmlException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(s, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(File f) throws XmlException, IOException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(f, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(URL u) throws XmlException, IOException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(u, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(InputStream is) throws XmlException, IOException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(is, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(Reader r) throws XmlException, IOException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(r, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(xis, XmlLong.type, (XmlOptions)null);
      }
      ...
      public static XmlLong parse(XMLStreamReader xsr) throws XmlException {
         return (XmlLong)XmlBeans.getContextTypeLoader().parse(xsr, XmlLong.type, (XmlOptions)null);
      }
