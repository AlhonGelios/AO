...
public abstract class Path {
   ...
   abstract Path.PathEngine execute(Cur var1, XmlOptions var2);
   ...
   private static synchronized Path getCompiledPathDelegate(String pathExpr, String currentVar, Map namespaces, String delIntfName) {
      ...
      int offset = ((Map)namespaces).get("$xmlbeans!ns_boundary") == null?0:((Integer)((Map)namespaces).get("$xmlbeans!ns_boundary")).intValue();
      ...
      if(!_xdkAvailable) {
         ...
         if(_xdkCompilePath == null) {
            try {
               ...
               _xdkCompilePath = args.getDeclaredMethod("compilePath", new Class[]{String.class, String.class, Boolean.class});
         ...
         Object[] args1 = new Object[]{pathExpr, currentVar, new Boolean(true)};

         try {
            return (Path)_xdkCompilePath.invoke((Object)null, args1);
      ...
      if(!_xqrlAvailable) {
         ...
         if(_xqrlCompilePath == null) {
            try {
               ...
               _xqrlCompilePath = args.getDeclaredMethod("compilePath", new Class[]{String.class, String.class, Boolean.class});
            } catch (ClassNotFoundException var7) {
         ...
         try {
            return (Path)_xqrlCompilePath.invoke((Object)null, args1);
         } catch (InvocationTargetException var5) {
            Throwable t = var5.getCause();
            throw new RuntimeException(t.getMessage(), t);
         } catch (IllegalAccessException var6) {
      ...
      if(!_xqrl2002Available) {
         ...
         if(_xqrl2002CompilePath == null) {
            try {
               ...
               _xqrl2002CompilePath = args.getDeclaredMethod("compilePath", new Class[]{String.class, String.class, Boolean.class});
            } catch (ClassNotFoundException var7) {
         ...
         try {
            return (Path)_xqrl2002CompilePath.invoke((Object)null, args1);
         } catch (InvocationTargetException var5) {
            Throwable t = var5.getCause();
            throw new RuntimeException(t.getMessage(), t);
         } catch (IllegalAccessException var6) {
   ...
   private static final class DelegatePathImpl extends Path {
      ...
      static final boolean $assertionsDisabled = !Path.class.desiredAssertionStatus();
      ...
      static Path create(String implClassName, String pathExpr, String currentNodeVar, Map namespaceMap) {
         if(!$assertionsDisabled && currentNodeVar.startsWith("$")) {
            ...
            return impl == null?null:new Path.DelegatePathImpl(impl, pathExpr);
         }
      }
      ...
      protected Path.PathEngine execute(Cur c, XmlOptions options) {
         return new Path.DelegatePathImpl.DelegatePathEngine(this._xpathImpl, c);
      }


      private static class DelegatePathEngine extends XPath.ExecutionContext implements Path.PathEngine {
                  ...
                  for(int i = 0; i < resultsList.size(); ++i) {
                     ...
                     if(!(node instanceof Node)) {
                        ...
                        try {
                           ...
                           Locale.autoTypeDocument(pos, e, (XmlOptions)null);
                           pos.next();
   ...
   private static final class XbeanPath extends Path {
      ...
      static Path create(String pathExpr, String currentVar, Map namespaces) {
         try {
            return new Path.XbeanPath(pathExpr, currentVar, XPath.compileXPath(pathExpr, currentVar, namespaces));
      ...
      Path.PathEngine execute(Cur c, XmlOptions options) {
         ...
         if(c.isContainer() && !this._compiledPath.sawDeepDot()) {
            return new Path.XbeanPathEngine(this._compiledPath, c);
         } else {
            byte force = 22;
   ...
   private static final class XbeanPathEngine extends XPath.ExecutionContext implements Path.PathEngine {
