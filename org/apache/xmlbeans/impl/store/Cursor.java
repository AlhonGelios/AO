...
public final class Cursor implements XmlCursor, Locale.ChangeListener {
   ...
   public XmlCursor.ChangeStamp _getDocChangeStamp() {
      return new Cursor.ChangeStampImpl(this._cur._locale);
   }
   ...
   public void _save(File file, XmlOptions options) throws IOException {
      if(file == null) {
         ...
         try {
            this._save((OutputStream)os, options);
         } finally {
            os.close();
         }
   ...
   public Node _newDomNode(XmlOptions options) {
      ...
      return (new Cursor.DomSaver(this._cur, this.isDomFragment(), options)).saveDom();
   }
   ...
   public boolean _moveXml(Cursor to) {
      ...
      if(this._cur.isText()) {
         int c1 = this._cur.cchRight();

         assert c1 > 0;

         if(this._cur.inChars(to._cur, c1, true)) {
            return false;
         } else {
            this._cur.moveChars(to._cur, c1);
            to._cur.nextChars(c1);
            return true;
         }
   ...
   public void _beginElement(QName name) {
      this._insertElementWithText(name, (String)null);
      this._toPrevToken();
   }
   ...
   public void _insertAttribute(String localName) {
      this._insertAttributeWithValue(localName, (String)null);
   }
   ...
   public void _insertAttribute(QName name) {
      this._insertAttributeWithValue(name, (String)null);
   }
   ...
   public int comparePosition(XmlCursor xOther) {
      ...
      if(this._cur._locale.noSync()) {
         ...
         int var16;
         try {
            var16 = this._comparePosition(other);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean isAtSamePositionAs(XmlCursor xOther) {
      ...
      if(this._cur._locale.noSync()) {
         ...
         boolean var16;
         try {
            var16 = this._isAtSamePositionAs(other);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlDocumentProperties documentProperties() {
      if(this.preCheck()) {
         ...
         XmlDocumentProperties var14;
         try {
            var14 = this._documentProperties();
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XMLStreamReader newXMLStreamReader() {
      if(this.preCheck()) {
         ...
         XMLStreamReader var14;
         try {
            var14 = this._newXMLStreamReader();
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XMLStreamReader newXMLStreamReader(XmlOptions options) {
      if(this.preCheck()) {
         ...
         XMLStreamReader var15;
         try {
            var15 = this._newXMLStreamReader(options);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XMLInputStream newXMLInputStream() {
      if(this.preCheck()) {
         ...
         XMLInputStream var14;
         try {
            var14 = this._newXMLInputStream();
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XMLInputStream newXMLInputStream(XmlOptions options) {
      if(this.preCheck()) {
         ...
         XMLInputStream var15;
         try {
            var15 = this._newXMLInputStream(options);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public InputStream newInputStream(XmlOptions options) {
      if(this.preCheck()) {
         ...
         InputStream var15;
         try {
            var15 = this._newInputStream(options);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public Node newDomNode(XmlOptions options) {
      if(this.preCheck()) {
         ...
         Node var15;
         try {
            var15 = this._newDomNode(options);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean toBookmark(XmlCursor.XmlBookmark bookmark) {
      if(this.preCheck()) {
         ...
         boolean var15;
         try {
            var15 = this._toBookmark(bookmark);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor.XmlBookmark toNextBookmark(Object key) {
      if(this.preCheck()) {
         ...
         XmlCursor.XmlBookmark var15;
         try {
            var15 = this._toNextBookmark(key);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor.XmlBookmark toPrevBookmark(Object key) {
      if(this.preCheck()) {
         ...
         XmlCursor.XmlBookmark var15;
         try {
            var15 = this._toPrevBookmark(key);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public String namespaceForPrefix(String prefix) {
      if(this.preCheck()) {
         ...
         String var15;
         try {
            var15 = this._namespaceForPrefix(prefix);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public String prefixForNamespace(String namespaceURI) {
      if(this.preCheck()) {
         ...
         String var15;
         try {
            var15 = this._prefixForNamespace(namespaceURI);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor.TokenType prevTokenType() {
      if(this.preCheck()) {
         ...
         XmlCursor.TokenType var14;
         try {
            var14 = this._prevTokenType();
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor.TokenType toFirstContentToken() {
      if(this.preCheck()) {
         ...
         XmlCursor.TokenType var14;
         try {
            var14 = this._toFirstContentToken();
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean toChild(String namespace, String name) {
      if(this.preCheck()) {
         ...
         boolean var16;
         try {
            var16 = this._toChild(namespace, name);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean toChild(QName name, int index) {
      if(this.preCheck()) {
         ...
         boolean var16;
         try {
            var16 = this._toChild(name, index);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean toNextSibling(String name) {
      if(this.preCheck()) {
         ...
         boolean var15;
         try {
            var15 = this._toNextSibling(name);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean toNextSibling(String namespace, String name) {
      if(this.preCheck()) {
         ...
         boolean var16;
         try {
            var16 = this._toNextSibling(namespace, name);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public String getAttributeText(QName attrName) {
      if(this.preCheck()) {
         ...
         String var15;
         try {
            var15 = this._getAttributeText(attrName);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean setAttributeText(QName attrName, String value) {
      if(this.preCheck()) {
         ...
         boolean var16;
         try {
            var16 = this._setAttributeText(attrName, value);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public boolean removeAttribute(QName attrName) {
      if(this.preCheck()) {
         ...
         boolean var15;
         try {
            var15 = this._removeAttribute(attrName);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public int getTextValue(char[] chars, int offset, int cch) {
      if(this.preCheck()) {
         ...
         int var17;
         try {
            var17 = this._getTextValue(chars, offset, cch);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public int getChars(char[] chars, int offset, int cch) {
      if(this.preCheck()) {
         ...
         int var17;
         try {
            var17 = this._getChars(chars, offset, cch);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor execQuery(String query, XmlOptions options) {
      if(this.preCheck()) {
         ...
         XmlCursor var16;
         try {
            var16 = this._execQuery(query, options);
         } finally {
            this._cur._locale.exit();
         }
   ...
   public XmlCursor.ChangeStamp getDocChangeStamp() {
      if(this.preCheck()) {
         ...
         XmlCursor.ChangeStamp var14;
         try {
            var14 = this._getDocChangeStamp();
         } finally {
            this._cur._locale.exit();
         }
   ...
   private static final class DomSaver extends Saver {
      ...
      static final boolean $assertionsDisabled = !Cursor.class.desiredAssertionStatus();
