...
public final class QueryDelegate {
   ...
   private static synchronized void init(String implClassName) {
      ...
      if(engineAvailable) {
         try {
            Constructor e = queryInterfaceImpl.getConstructor(new Class[]{String.class, String.class, Integer.class});
   ...
   public static synchronized QueryDelegate.QueryInterface createInstance(String implClassName, String query, String contextVar, int boundary) {
      ...
      if(_constructors.get(implClassName) == null) {
         ...
         try {
            return (QueryDelegate.QueryInterface)constructor.newInstance(new Object[]{query, contextVar, new Integer(boundary)});
