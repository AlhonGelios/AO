...
class RegexParser {
      ...
      if(this.offset != this.regexlen) {
         ...
         if(this.references != null) {
            for(int i = 0; i < this.references.size(); ++i) {
               RegexParser.ReferencePosition position = (RegexParser.ReferencePosition)this.references.elementAt(i);
   ...
   final void next() {
      if(this.offset >= this.regexlen) {
         ...
         if(this.context == 1) {
            switch(ch) {
            case 45:
               if(this.isSet(512) && this.offset < this.regexlen && this.regex.charAt(this.offset) == 91) {
                  ++this.offset;
                  ret = 24;
               } else {
                  ret = 0;
               ...
               break;
            case 91:
               if(!this.isSet(512) && this.offset < this.regexlen && this.regex.charAt(this.offset) == 58) {
                  ++this.offset;
                  ret = 20;
                  break;
               }
            ...
            default:
               if(REUtil.isHighSurrogate(ch) && this.offset < this.regexlen) {
                  char low = this.regex.charAt(this.offset);
            ...
            case 40:
               ret = 6;
               if(this.offset < this.regexlen && this.regex.charAt(this.offset) == 63) {
                  if(++this.offset >= this.regexlen) {
   ...
   Token parseRegex() throws ParseException {
      Object tok = this.parseTerm();

      for(Token.UnionToken parent = null; this.read() == 2; ((Token)tok).addChild(this.parseTerm())) {
         this.next();
         if(parent == null) {
   ...
   Token parseTerm() throws ParseException {
      int ch = this.read();
      if(ch != 2 && ch != 7 && ch != 1) {
         Object tok = this.parseFactor();

         for(Token.UnionToken concat = null; (ch = this.read()) != 2 && ch != 7 && ch != 1; concat.addChild(this.parseFactor())) {
            if(concat == null) {
   ...
   boolean checkQuestion(int off) {
      return off < this.regexlen && this.regex.charAt(off) == 63;
   }
   ...
   Token processCondition() throws ParseException {
      if(this.offset + 1 >= this.regexlen) {
         ...
         if(49 <= ch && ch <= 57) {
            ...
            this.references.addElement(new RegexParser.ReferencePosition(refno, this.offset));
            ++this.offset;
            if(this.regex.charAt(this.offset) != 41) {
   ...
   Token processModifiers() throws ParseException {
      ...
      if(this.offset >= this.regexlen) {
         ...
         if(ch == 58) {
            ++this.offset;
            this.next();
            var5 = Token.createModifierGroup(this.parseRegex(), add, mask);
            if(this.read() != 7) {
               throw this.ex("parser.factor.1", this.offset - 1);
            }
   ...
   Token processBackreference() throws ParseException {
      ...
      this.references.addElement(new RegexParser.ReferencePosition(refnum, this.offset - 2));
      this.next();
      return tok;
   }
   ...
   Token parseFactor() throws ParseException {
      ...
      case 0:
         if(this.chardata == 123 && this.offset < this.regexlen) {
            ...
            boolean max = true;
            char var6;
            if((var6 = this.regex.charAt(off++)) < 48 || var6 > 57) {
               throw this.ex("parser.quantifier.1", this.offset);
            } else {
               int var7 = var6 - 48;

               while(off < this.regexlen && (var6 = this.regex.charAt(off++)) >= 48 && var6 <= 57) {
               ...
               if(var6 != 125) {
                  ...
                  ((Token)tok).setMin(var7);
                  ((Token)tok).setMax(var8);
                  this.next();
               }
            }
         }
   ...
   Token parseAtom() throws ParseException {
      ...
      case 10:
         ...
         case 115:
         case 119:
            Token tok1 = this.getTokenForShorthand(this.chardata);
            this.next();
            return tok1;
         case 73:
         ...
         case 112:
            ...
            if(tok == null) {
               throw this.ex("parser.atom.5", high);
            }
            break;
         case 88:
         ...
         case 118:
         case 120:
            high = this.decodeEscaped();
            if(high < 65536) {
               tok = Token.createChar(high);
            } else {
               tok = Token.createString(REUtil.decomposeToSurrogates(high));
            }
            break;
         case 103:
      ...
      while((type = this.read()) != 1 && (type != 0 || this.chardata != 93 || firstloop)) {
         ...
         if(type == 10) {
            ...
            case 112:
               ...
               RangeToken positive = this.processBacksolidus_pP(c);
               if(positive == null) {
                  throw this.ex("parser.atom.5", rangeend);
               }

               tok.mergeRanges(positive);
               end = true;
               break;
            default:
            ...
            if(this.regex.charAt(this.offset) == 94) {
               ++this.offset;
               positive1 = false;
            }

            String name = this.regex.substring(this.offset, rangeend);
            RangeToken range = Token.getRange(name, positive1, this.isSet(512));
            if(range == null) {
            ...
            if(rangeend + 1 >= this.regexlen || this.regex.charAt(rangeend + 1) != 93) {
   ...
   int decodeEscaped() throws ParseException {
      if(this.read() != 10) {
         ...
         case 117:
            v11 = 0;
            this.next();
            if(this.read() != 0 || (v11 = hexChar(this.chardata)) < 0) {
         ...
         case 120:
            ...
            if(this.chardata == 123) {
               ...
               while(true) {
                  ...
                  if((v11 = hexChar(this.chardata)) < 0) {
   ...
   private static final int hexChar(int ch) {
      return ch < 48?-1:(ch > 102?-1:(ch <= 57?ch - 48:(ch < 65?-1:(ch <= 70?ch - 65 + 10:(ch < 97?-1:ch - 97 + 10)))));
   }
