...
public class SniffedXmlInputStream extends BufferedInputStream {
   ...
   private String sniffForXmlDecl(String encoding) throws IOException {
      ...
      try {
         ...
         InputStreamReader reader = new InputStreamReader(new ByteArrayInputStream(bytebuf, 0, bytelimit), charset);
         ...
         while(true) {
            ...
            String count1 = extractXmlDeclEncoding(buf, 0, limit);
            return count1;
         }
      } finally {
         this.reset();
   ...
   static String extractXmlDeclEncoding(char[] buf, int offset, int size) {
      ...
      if(xmlpi >= 0) {
         int i = xmlpi + 5;
         SniffedXmlInputStream.ScannedAttribute attr = new SniffedXmlInputStream.ScannedAttribute((SniffedXmlInputStream.NamelessClass994770145)null);
   ...
   private static int scanAttribute(char[] buf, int startAt, int limit, SniffedXmlInputStream.ScannedAttribute attr) {
   ...
   static class NamelessClass994770145 {
   }
   ...
   private static class ScannedAttribute {
      ...
      ScannedAttribute(SniffedXmlInputStream.NamelessClass994770145 x0) {
         this();
      }
   }
}
