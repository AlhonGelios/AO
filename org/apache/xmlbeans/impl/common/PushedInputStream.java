...
public abstract class PushedInputStream extends InputStream {
   ...
   public PushedInputStream(int size) {
      this.markpos = -1;
      this.outputStream = new PushedInputStream.InternalOutputStream((PushedInputStream.NamelessClass1177447880)null);
      if(size < 0) {
   ...
   static void access$100(PushedInputStream x0, int x1) {
      x0.shift(x1);
   }


   static class NamelessClass1177447880 {
   }
   ...
   private class InternalOutputStream extends OutputStream {
      ...
      InternalOutputStream(PushedInputStream.NamelessClass1177447880 x1) {
         this();
      }
   }
}
