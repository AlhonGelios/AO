...
public class GenericXmlInputStream implements XMLInputStream {
   ...
   private GenericXmlInputStream.EventItem _nextEvent;
   ...
   private GenericXmlInputStream.EventItem getNextEvent() throws XMLStreamException {
      XMLEvent e = this.nextEvent();
      return e == null?null:new GenericXmlInputStream.EventItem(e);
   }

   public XMLEvent next() throws XMLStreamException {
      this.ensureInit();
      GenericXmlInputStream.EventItem currentEvent = this._nextEvent;
   ...
   private class EventItem {
      ...
      GenericXmlInputStream.EventItem _next;
