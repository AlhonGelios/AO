...
public class ValidatingXMLStreamReader extends StreamReaderDelegate implements XMLStreamReader {
   ...
   private final ValidatingXMLStreamReader.ElementEventImpl _elemEvent = new ValidatingXMLStreamReader.ElementEventImpl((ValidatingXMLStreamReader.NamelessClass1392316022)null);
   private final ValidatingXMLStreamReader.AttributeEventImpl _attEvent = new ValidatingXMLStreamReader.AttributeEventImpl((ValidatingXMLStreamReader.NamelessClass1392316022)null);
   private final ValidatingXMLStreamReader.SimpleEventImpl _simpleEvent = new ValidatingXMLStreamReader.SimpleEventImpl((ValidatingXMLStreamReader.NamelessClass1392316022)null);
   private ValidatingXMLStreamReader.PackTextXmlStreamReader _packTextXmlStreamReader = new ValidatingXMLStreamReader.PackTextXmlStreamReader((ValidatingXMLStreamReader.NamelessClass1392316022)null);
   private int _state;
         ...
         if(this._depth < 0) {
            ...
            case 1:
               ...
               if(this._validator == null) {
                  QName attCount = new QName(this.getNamespaceURI(), this.getLocalName());
                  if(this._contentType == null) {
                     this._contentType = this.typeForGlobalElement(attCount);
                  }
               ...
               this._validator.nextEvent(1, this._elemEvent);
               int var8 = this.getAttributeCount();
               this.validate_attributes(var8);
               break;
            case 2:
            case 8:
               --this._depth;
   ...
   private boolean isSpecialAttribute(QName qn) {
      return !qn.getNamespaceURI().equals("http://www.w3.org/2001/XMLSchema-instance")?false:qn.getLocalPart().equals(XSI_TYPE.getLocalPart()) || qn.getLocalPart().equals(XSI_NIL.getLocalPart()) || qn.getLocalPart().equals(XSI_SL.getLocalPart()) || qn.getLocalPart().equals(XSI_NSL.getLocalPart());
   }
   ...
   private static final class AttributeEventImpl implements ValidatorListener.Event {
      ...
      static final boolean $assertionsDisabled = !ValidatingXMLStreamReader.class.desiredAssertionStatus();
      ...
      AttributeEventImpl(ValidatingXMLStreamReader.NamelessClass1392316022 x0) {
         this();
      }

      static void access$500(ValidatingXMLStreamReader.AttributeEventImpl x0, XMLStreamReader x1) {
         x0.setXMLStreamReader(x1);
      }

      static void access$700(ValidatingXMLStreamReader.AttributeEventImpl x0, int x1) {
         x0.setAttributeIndex(x1);
      }

   }

   static class NamelessClass1392316022 {
   }
   ...
   private static class PackTextXmlStreamReader extends StreamReaderDelegate implements XMLStreamReader {
      ...
      PackTextXmlStreamReader(ValidatingXMLStreamReader.NamelessClass1392316022 x0) {
         this();
      }
   ...
   private static class ElementEventImpl implements ValidatorListener.Event {
      ...
      ElementEventImpl(ValidatingXMLStreamReader.NamelessClass1392316022 x0) {
         this();
      }

      static void access$400(ValidatingXMLStreamReader.ElementEventImpl x0, XMLStreamReader x1) {
         x0.setXMLStreamReader(x1);
      }
   }
   ...
   private static final class SimpleEventImpl implements ValidatorListener.Event {
      ...
      SimpleEventImpl(ValidatingXMLStreamReader.NamelessClass1392316022 x0) {
         this();
      }

      static void access$600(ValidatingXMLStreamReader.SimpleEventImpl x0, XMLStreamReader x1) {
         x0.setXMLStreamReader(x1);
      }

      static QName access$802(ValidatingXMLStreamReader.SimpleEventImpl x0, QName x1) {
         return x0._qname = x1;
      }

      static String access$902(ValidatingXMLStreamReader.SimpleEventImpl x0, String x1) {
         return x0._text = x1;
      }
   }
}
