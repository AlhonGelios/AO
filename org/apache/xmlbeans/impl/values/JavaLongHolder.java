...
public abstract class JavaLongHolder extends XmlObjectBase {
   ...
   protected int compare_to(XmlObject l) {
      return ((SimpleValue)l).instanceType().getDecimalSize() > 64?-l.compareTo(this):(this._value == ((XmlObjectBase)l).longValue()?0:(this._value < ((XmlObjectBase)l).longValue()?-1:1));
   }

   protected boolean equal_to(XmlObject l) {
      return ((SimpleValue)l).instanceType().getDecimalSize() > 64?l.valueEquals(this):this._value == ((XmlObjectBase)l).longValue();
   }
