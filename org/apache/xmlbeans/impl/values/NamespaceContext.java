...
public class NamespaceContext implements PrefixResolver {
   ...
   private static NamespaceContext.NamespaceContextStack getNamespaceContextStack() {
      NamespaceContext.NamespaceContextStack namespaceContextStack = (NamespaceContext.NamespaceContextStack)tl_namespaceContextStack.get();
      if(namespaceContextStack == null) {
         namespaceContextStack = new NamespaceContext.NamespaceContextStack((NamespaceContext.NamelessClass344570892)null);
   ...
   public static void pop() {
      NamespaceContext.NamespaceContextStack nsContextStack = getNamespaceContextStack();
      nsContextStack.pop();
   ...
   private static final class NamespaceContextStack {
      ...
      NamespaceContextStack(NamespaceContext.NamelessClass344570892 x0) {
         this();
      }
   }

   static class NamelessClass344570892 {
   }
}
