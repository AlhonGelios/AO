...
public class XMLStreamReaderExtImpl implements XMLStreamReaderExt {
   ...
   private final XMLStreamReaderExtImpl.CharSeqTrimWS _charSeq;
   ...
   public XMLStreamReaderExtImpl(XMLStreamReader xmlStream) {
      if(xmlStream == null) {
         ...
         this._charSeq = new XMLStreamReaderExtImpl.CharSeqTrimWS(this);
      }
   }
   ...
   public Date getAttributeDateValue(String uri, String local) throws XMLStreamException {
      try {
         CharSequence e = this._charSeq.reloadAtt(uri, local, 2);
         return (new GDateBuilder(e)).getDate();
   ...
   static String access$000(XMLStreamReaderExtImpl x0) {
      return x0._defaultValue;
   }

   static String access$002(XMLStreamReaderExtImpl x0, String x1) {
      return x0._defaultValue = x1;
   }
   ...
   private static class CharSeqTrimWS implements CharSequence {
      ...
      static final boolean $assertionsDisabled = !XMLStreamReaderExtImpl.class.desiredAssertionStatus();
      ...
      CharSeqTrimWS(XMLStreamReaderExtImpl xmlSteam) {
         ...
         this._location = new XMLStreamReaderExtImpl.CharSeqTrimWS.ExtLocation();
      }
      ...
      Location getLocation() {
         XMLStreamReaderExtImpl.CharSeqTrimWS.ExtLocation loc = new XMLStreamReaderExtImpl.CharSeqTrimWS.ExtLocation();
