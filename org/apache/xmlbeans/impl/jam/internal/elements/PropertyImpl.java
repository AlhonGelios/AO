...
public class PropertyImpl extends AnnotatedElementImpl implements JProperty {
   ...
   public JAnnotation getAnnotation(String named) {
      ...
      return out != null?out:(this.mSetter != null?this.mSetter.getAnnotation(named):null);
   }

   public JComment getComment() {
      return this.mGetter != null?this.mGetter.getComment():(this.mSetter != null?this.mSetter.getComment():null);
   }
