...
public class AnnotationValueImpl implements JAnnotationValue {
   ...
   public boolean asBoolean() throws IllegalArgumentException {
      return this.mValue == null?false:Boolean.valueOf(this.mValue.toString().trim()).booleanValue();
   }
      ...
      if(!this.mValue.getClass().isArray()) {
         ...
         for(int i = 0; i < out.length; ++i) {
            if(((Object[])((Object[])this.mValue))[i] == null) {
               ...
               out[i] = Boolean.valueOf(((Object[])((Object[])this.mValue))[i].toString()).booleanValue();
            }
         }
   ...
   private static final Object[] ensureArrayWrapped(Object o) {
      if(o instanceof Object[]) {
         ...
         if(o instanceof int[]) {
            ...
            Integer[] var10 = new Integer[dims];

            for(i = 0; i < dims; ++i) {
               var10[i] = new Integer(((int[])((int[])o))[i]);
            }

            return var10;
         } else if(o instanceof boolean[]) {
            dims = ((boolean[])((boolean[])o)).length;
            Boolean[] var9 = new Boolean[dims];

            for(i = 0; i < dims; ++i) {
               var9[i] = Boolean.valueOf(((boolean[])((boolean[])o))[i]);
            }

            return var9;
         } else if(o instanceof byte[]) {
            dims = ((byte[])((byte[])o)).length;
            Byte[] var8 = new Byte[dims];

            for(i = 0; i < dims; ++i) {
               var8[i] = new Byte(((byte[])((byte[])o))[i]);
            }

            return var8;
         } else if(o instanceof char[]) {
            dims = ((char[])((char[])o)).length;
            Character[] var7 = new Character[dims];

            for(i = 0; i < dims; ++i) {
               var7[i] = new Character(((char[])((char[])o))[i]);
            }

            return var7;
         } else if(o instanceof float[]) {
            dims = ((float[])((float[])o)).length;
            Float[] var6 = new Float[dims];

            for(i = 0; i < dims; ++i) {
               var6[i] = new Float(((float[])((float[])o))[i]);
            }

            return var6;
         } else if(o instanceof double[]) {
            dims = ((double[])((double[])o)).length;
            Double[] var5 = new Double[dims];

            for(i = 0; i < dims; ++i) {
               var5[i] = new Double(((double[])((double[])o))[i]);
            }

            return var5;
         } else if(o instanceof long[]) {
            dims = ((long[])((long[])o)).length;
            Long[] var4 = new Long[dims];

            for(i = 0; i < dims; ++i) {
               var4[i] = new Long(((long[])((long[])o))[i]);
            }
