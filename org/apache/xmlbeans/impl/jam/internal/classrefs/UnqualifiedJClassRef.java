...
public class UnqualifiedJClassRef implements JClassRef {
   ...
   private String qualifyName(String ucname) {
      String out = null;
      return (out = this.checkExplicitImport(ucname)) != null?out:((out = this.checkJavaLang(ucname)) != null?out:((out = this.checkSamePackage(ucname)) != null?out:((out = this.checkAlreadyQualified(ucname)) != null?out:null)));
   }
