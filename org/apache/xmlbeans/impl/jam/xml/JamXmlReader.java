         ...
         while("annotation-value".equals(this.getElementName())) {
            ...
            if(jclass.isArrayType()) {
               ...
               while("value".equals(this.getElementName())) {
                  String vals = this.assertCurrentString("value");
                  value.add(vals);
               }

               String[] vals1 = new String[value.size()];
               value.toArray(vals1);
               ann.setSimpleValue(name, vals1, jclass);
            } else {
               String value1 = this.assertCurrentString("value");
               ann.setSimpleValue(name, value1, jclass);
            }
