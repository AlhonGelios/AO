...
public class DownloadedSchemaEntryImpl extends XmlComplexContentImpl implements DownloadedSchemaEntry {
   ...
   public XmlToken xgetFilename() {
      synchronized(this.monitor()) {
         ...
         target = (XmlToken)this.get_store().find_element_user(FILENAME$0, 0);
         return target;
      }
   }
   ...
   public String getSha1() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(SHA1$2, 0);
         return target == null?null:target.getStringValue();
      }
   }
   ...
   public XmlToken xgetSha1() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlToken target = null;
         target = (XmlToken)this.get_store().find_element_user(SHA1$2, 0);
         return target;
      }
   }
   ...
   public String getNamespace() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(NAMESPACE$6, 0);
         return target == null?null:target.getStringValue();
      }
   }
   ...
   public XmlAnyURI xgetNamespace() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlAnyURI target = null;
         target = (XmlAnyURI)this.get_store().find_element_user(NAMESPACE$6, 0);
         return target;
      }
   }
