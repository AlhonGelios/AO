...
public interface Attribute extends Annotated {
   ...
   void setUse(Attribute.Use.Enum var1);

   void xsetUse(Attribute.Use var1);
   ...
   static class NamelessClass449232220 {
   }
   ...
   public interface Use extends XmlNMTOKEN {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Attribute.Use.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("usea41aattrtype");
      Attribute.Use.Enum PROHIBITED = Attribute.Use.Enum.forString("prohibited");
      Attribute.Use.Enum OPTIONAL = Attribute.Use.Enum.forString("optional");
      Attribute.Use.Enum REQUIRED = Attribute.Use.Enum.forString("required");
      ...
      public static final class Factory {
         ...
         public static Attribute.Use newValue(Object obj) {
            return (Attribute.Use)Attribute.Use.type.newValue(obj);
         }

         public static Attribute.Use newInstance() {
            return (Attribute.Use)XmlBeans.getContextTypeLoader().newInstance(Attribute.Use.type, (XmlOptions)null);
         }

         public static Attribute.Use newInstance(XmlOptions options) {
            return (Attribute.Use)XmlBeans.getContextTypeLoader().newInstance(Attribute.Use.type, options);
         }
      ...
      public static final class Enum extends StringEnumAbstractBase {
         ...
         public static Attribute.Use.Enum forString(String s) {
            return (Attribute.Use.Enum)table.forString(s);
         }
