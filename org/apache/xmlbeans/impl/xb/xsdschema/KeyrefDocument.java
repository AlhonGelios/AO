...
public interface KeyrefDocument extends XmlObject {
   ...
   KeyrefDocument.Keyref getKeyref();

   void setKeyref(KeyrefDocument.Keyref var1);
   ...
   public interface Keyref extends Keybase {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(KeyrefDocument.Keyref.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("keyref7a1felemtype");
      ...
      public static final class Factory {
         ...
         public static KeyrefDocument.Keyref newInstance() {
            return (KeyrefDocument.Keyref)XmlBeans.getContextTypeLoader().newInstance(KeyrefDocument.Keyref.type, (XmlOptions)null);
         }

         public static KeyrefDocument.Keyref newInstance(XmlOptions options) {
            return (KeyrefDocument.Keyref)XmlBeans.getContextTypeLoader().newInstance(KeyrefDocument.Keyref.type, options);
         }

      }
   }

   static class NamelessClass1684147011 {
   }
}
