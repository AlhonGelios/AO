...
public interface NamespaceList extends XmlAnySimpleType {
   ...
   public interface Member2 extends XmlAnySimpleType {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamespaceList.Member2.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("anona0e6type");
      ...
      public interface Item extends XmlAnySimpleType {
         ...
         SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamespaceList.Member2.Item.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("anon16cetype");
         ...
         public interface Member extends XmlToken {
            ...
            SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamespaceList.Member2.Item.Member.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("anon0c73type");
            NamespaceList.Member2.Item.Member.Enum TARGET_NAMESPACE = NamespaceList.Member2.Item.Member.Enum.forString("##targetNamespace");
   ...
   static class NamelessClass1591737454 {
   }
   ...
   public interface Member extends XmlToken {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamespaceList.Member.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("anonfac7type");
      NamespaceList.Member.Enum ANY = NamespaceList.Member.Enum.forString("##any");
      NamespaceList.Member.Enum OTHER = NamespaceList.Member.Enum.forString("##other");
      int INT_ANY = 1;
      int INT_OTHER = 2;
      ...
      public static final class Enum extends StringEnumAbstractBase {
         ...
         public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new NamespaceList.Member.Enum[]{new NamespaceList.Member.Enum("##any", 1), new NamespaceList.Member.Enum("##other", 2)});
         private static final long serialVersionUID = 1L;
