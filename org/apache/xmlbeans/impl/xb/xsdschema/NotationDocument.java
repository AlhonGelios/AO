...
public interface NotationDocument extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NotationDocument.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("notation3381doctype");


   NotationDocument.Notation getNotation();

   void setNotation(NotationDocument.Notation var1);
   ...
   static class NamelessClass1948147832 {
   }

   public interface Notation extends Annotated {

      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NotationDocument.Notation.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("notation8b1felemtype");
      ...
      public static final class Factory {
         ...
         public static NotationDocument.Notation newInstance() {
            return (NotationDocument.Notation)XmlBeans.getContextTypeLoader().newInstance(NotationDocument.Notation.type, (XmlOptions)null);
         }

         public static NotationDocument.Notation newInstance(XmlOptions options) {
            return (NotationDocument.Notation)XmlBeans.getContextTypeLoader().newInstance(NotationDocument.Notation.type, options);
         }
