...
public interface AppinfoDocument extends XmlObject {
   ...
   AppinfoDocument.Appinfo getAppinfo();

   void setAppinfo(AppinfoDocument.Appinfo var1);
   ...
   public interface Appinfo extends XmlObject {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(AppinfoDocument.Appinfo.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("appinfo650belemtype");
      ...
      public static final class Factory {
         ...
         public static AppinfoDocument.Appinfo newInstance() {
            return (AppinfoDocument.Appinfo)XmlBeans.getContextTypeLoader().newInstance(AppinfoDocument.Appinfo.type, (XmlOptions)null);
         }

         public static AppinfoDocument.Appinfo newInstance(XmlOptions options) {
            return (AppinfoDocument.Appinfo)XmlBeans.getContextTypeLoader().newInstance(AppinfoDocument.Appinfo.type, options);
         }

      }
   }

   static class NamelessClass1811814955 {
   }
