...
public interface NamedGroup extends RealGroup {
   ...
   static class NamelessClass411955198 {
   }

   public interface All extends All {

      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamedGroup.All.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("all82daelemtype");
      ...
      public static final class Factory {
         ...
         public static NamedGroup.All newInstance() {
            return (NamedGroup.All)XmlBeans.getContextTypeLoader().newInstance(NamedGroup.All.type, (XmlOptions)null);
         }

         public static NamedGroup.All newInstance(XmlOptions options) {
            return (NamedGroup.All)XmlBeans.getContextTypeLoader().newInstance(NamedGroup.All.type, options);
         }
