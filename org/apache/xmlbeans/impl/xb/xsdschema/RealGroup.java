...
public interface RealGroup extends Group {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RealGroup.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("realgroup1f64type");
   ...
   static class NamelessClass926366332 {
   }
}
