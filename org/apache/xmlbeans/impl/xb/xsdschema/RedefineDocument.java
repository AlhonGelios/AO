...
public interface RedefineDocument extends XmlObject {
   ...
   RedefineDocument.Redefine getRedefine();

   void setRedefine(RedefineDocument.Redefine var1);
   ...
   static class NamelessClass790222745 {
   }

   public interface Redefine extends OpenAttrs {

      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RedefineDocument.Redefine.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("redefine9e9felemtype");
      ...
      public static final class Factory {
         ...
         public static RedefineDocument.Redefine newInstance() {
            return (RedefineDocument.Redefine)XmlBeans.getContextTypeLoader().newInstance(RedefineDocument.Redefine.type, (XmlOptions)null);
         }

         public static RedefineDocument.Redefine newInstance(XmlOptions options) {
            return (RedefineDocument.Redefine)XmlBeans.getContextTypeLoader().newInstance(RedefineDocument.Redefine.type, options);
         }
