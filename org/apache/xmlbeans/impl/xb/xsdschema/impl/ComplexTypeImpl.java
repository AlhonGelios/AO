...
public class ComplexTypeImpl extends AnnotatedImpl implements ComplexType {
   ...
   public SimpleContentDocument.SimpleContent getSimpleContent() {
      synchronized(this.monitor()) {
         ...
         target = (SimpleContentDocument.SimpleContent)this.get_store().find_element_user(SIMPLECONTENT$0, 0);
   ...
   public ComplexContentDocument.ComplexContent getComplexContent() {
      synchronized(this.monitor()) {
         ...
         target = (ComplexContentDocument.ComplexContent)this.get_store().find_element_user(COMPLEXCONTENT$2, 0);
         return target == null?null:target;
      }
   }
   ...
   public GroupRef getGroup() {
      synchronized(this.monitor()) {
         ...
         target = (GroupRef)this.get_store().find_element_user(GROUP$4, 0);
         return target == null?null:target;
      }
   }
   ...
   public All getAll() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         All target = null;
         target = (All)this.get_store().find_element_user(ALL$6, 0);
         return target == null?null:target;
      }
   }
   ...
   public ExplicitGroup getChoice() {
      synchronized(this.monitor()) {
         ...
         target = (ExplicitGroup)this.get_store().find_element_user(CHOICE$8, 0);
         return target == null?null:target;
      }
   }
   ...
   public ExplicitGroup getSequence() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ExplicitGroup target = null;
         target = (ExplicitGroup)this.get_store().find_element_user(SEQUENCE$10, 0);
         return target == null?null:target;
      }
   }
   ...
   public Wildcard getAnyAttribute() {
      synchronized(this.monitor()) {
         ...
         target = (Wildcard)this.get_store().find_element_user(ANYATTRIBUTE$16, 0);
         return target == null?null:target;
      }
   }
