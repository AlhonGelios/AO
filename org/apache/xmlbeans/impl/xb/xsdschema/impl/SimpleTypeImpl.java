...
public class SimpleTypeImpl extends AnnotatedImpl implements SimpleType {
   ...
   public RestrictionDocument.Restriction getRestriction() {
      synchronized(this.monitor()) {
         ...
         target = (RestrictionDocument.Restriction)this.get_store().find_element_user(RESTRICTION$0, 0);
   ...
   public ListDocument.List getList() {
      synchronized(this.monitor()) {
         ...
         target = (ListDocument.List)this.get_store().find_element_user(LIST$2, 0);
         return target == null?null:target;
      }
   }
   ...
   public UnionDocument.Union getUnion() {
      synchronized(this.monitor()) {
         ...
         target = (UnionDocument.Union)this.get_store().find_element_user(UNION$4, 0);
         return target == null?null:target;
      }
   }
