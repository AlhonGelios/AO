...
public class RestrictionTypeImpl extends AnnotatedImpl implements RestrictionType {
   ...
   public GroupRef getGroup() {
      synchronized(this.monitor()) {
         ...
         target = (GroupRef)this.get_store().find_element_user(GROUP$0, 0);
   ...
   public All getAll() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         All target = null;
         target = (All)this.get_store().find_element_user(ALL$2, 0);
         return target == null?null:target;
      }
   }
   ...
   public ExplicitGroup getChoice() {
      synchronized(this.monitor()) {
         ...
         target = (ExplicitGroup)this.get_store().find_element_user(CHOICE$4, 0);
         return target == null?null:target;
      }
   }
   ...
   public ExplicitGroup getSequence() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ExplicitGroup target = null;
         target = (ExplicitGroup)this.get_store().find_element_user(SEQUENCE$6, 0);
         return target == null?null:target;
      }
   }
   ...
   public LocalSimpleType getSimpleType() {
      synchronized(this.monitor()) {
         ...
         target = (LocalSimpleType)this.get_store().find_element_user(SIMPLETYPE$8, 0);
         return target == null?null:target;
      }
   }
   ...
   public Wildcard getAnyAttribute() {
      synchronized(this.monitor()) {
         ...
         target = (Wildcard)this.get_store().find_element_user(ANYATTRIBUTE$38, 0);
         return target == null?null:target;
      }
   }
