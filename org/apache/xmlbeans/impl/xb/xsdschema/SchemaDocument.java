...
public interface SchemaDocument extends XmlObject {
   ...
   void setSchema(SchemaDocument.Schema var1);
   ...
   public interface Schema extends OpenAttrs {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SchemaDocument.Schema.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("schemad77felemtype");
      ...
      public static final class Factory {
         ...
         public static SchemaDocument.Schema newInstance() {
            return (SchemaDocument.Schema)XmlBeans.getContextTypeLoader().newInstance(SchemaDocument.Schema.type, (XmlOptions)null);
         }

         public static SchemaDocument.Schema newInstance(XmlOptions options) {
            return (SchemaDocument.Schema)XmlBeans.getContextTypeLoader().newInstance(SchemaDocument.Schema.type, options);
         }
   ...
   static class NamelessClass1322708387 {
   }
}
