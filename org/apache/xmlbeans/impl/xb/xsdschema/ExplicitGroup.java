...
public interface ExplicitGroup extends Group {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ExplicitGroup.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("explicitgroup4efatype");



   static class NamelessClass1712777434 {
   }
