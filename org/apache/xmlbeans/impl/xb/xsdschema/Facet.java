...
public interface Facet extends Annotated {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Facet.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("facet446etype");
   ...
   static class NamelessClass1475393983 {
   }
}
