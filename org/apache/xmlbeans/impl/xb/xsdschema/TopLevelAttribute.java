...
public interface TopLevelAttribute extends Attribute {
   ...
   public static final class Factory {
      ...
      public static TopLevelAttribute parse(String xmlAsString) throws XmlException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(xmlAsString, TopLevelAttribute.type, (XmlOptions)null);
      }
      ...
      public static TopLevelAttribute parse(URL u) throws XmlException, IOException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(u, TopLevelAttribute.type, (XmlOptions)null);
      }
      ...
      public static TopLevelAttribute parse(InputStream is) throws XmlException, IOException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(is, TopLevelAttribute.type, (XmlOptions)null);
      }
      ...
      public static TopLevelAttribute parse(Reader r) throws XmlException, IOException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(r, TopLevelAttribute.type, (XmlOptions)null);
      }
      ...
      public static TopLevelAttribute parse(XMLStreamReader sr) throws XmlException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(sr, TopLevelAttribute.type, (XmlOptions)null);
      }
      ...
      public static TopLevelAttribute parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (TopLevelAttribute)XmlBeans.getContextTypeLoader().parse(xis, TopLevelAttribute.type, (XmlOptions)null);
      }
   ...
   static class NamelessClass707986400 {
   }
}
