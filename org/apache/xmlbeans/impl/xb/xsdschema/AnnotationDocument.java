...
public interface AnnotationDocument extends XmlObject {
   ...
   public interface Annotation extends OpenAttrs {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(AnnotationDocument.Annotation.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("annotation5abfelemtype");
      ...
      public static final class Factory {
         ...
         public static AnnotationDocument.Annotation newInstance() {
            return (AnnotationDocument.Annotation)XmlBeans.getContextTypeLoader().newInstance(AnnotationDocument.Annotation.type, (XmlOptions)null);
         }

         public static AnnotationDocument.Annotation newInstance(XmlOptions options) {
            return (AnnotationDocument.Annotation)XmlBeans.getContextTypeLoader().newInstance(AnnotationDocument.Annotation.type, options);
         }

      }
   }

   static class NamelessClass1198130071 {
   }
