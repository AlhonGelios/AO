...
public interface SimpleExplicitGroup extends ExplicitGroup {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SimpleExplicitGroup.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("simpleexplicitgroup428ctype");
   ...
   static class NamelessClass295212754 {
   }
}
