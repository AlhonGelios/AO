...
public interface RestrictionDocument extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RestrictionDocument.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("restriction0049doctype");
   ...
   static class NamelessClass103387501 {
   }
   ...
   public interface Restriction extends Annotated {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RestrictionDocument.Restriction.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("restrictionad11elemtype");
      ...
      public static final class Factory {
         ...
         public static RestrictionDocument.Restriction newInstance() {
            return (RestrictionDocument.Restriction)XmlBeans.getContextTypeLoader().newInstance(RestrictionDocument.Restriction.type, (XmlOptions)null);
         }

         public static RestrictionDocument.Restriction newInstance(XmlOptions options) {
            return (RestrictionDocument.Restriction)XmlBeans.getContextTypeLoader().newInstance(RestrictionDocument.Restriction.type, options);
         }
