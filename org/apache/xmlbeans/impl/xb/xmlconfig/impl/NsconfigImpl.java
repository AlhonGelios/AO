...
public class NsconfigImpl extends XmlComplexContentImpl implements Nsconfig {
   ...
   public String getPackage() {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(PACKAGE$0, 0);
   ...
   public XmlString xgetPackage() {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(PACKAGE$0, 0);
         return target;
      }
   }
   ...
   public String getPrefix() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(PREFIX$2, 0);
         return target == null?null:target.getStringValue();
      }
   }
   ...
   public XmlString xgetPrefix() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PREFIX$2, 0);
         return target;
      }
   }
   ...
   public String getSuffix() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(SUFFIX$4, 0);
         return target == null?null:target.getStringValue();
      }
   }
   ...
   public XmlString xgetSuffix() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(SUFFIX$4, 0);
         return target;
      }
   }
