...
public interface TestCase extends XmlObject {
   ...
   void setFiles(TestCase.Files var1);
   ...
   public interface Files extends XmlObject {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TestCase.Files.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLTOOLS").resolveHandle("files7c3eelemtype");
      ...
      public static final class Factory {
         ...
         public static TestCase.Files newInstance() {
            return (TestCase.Files)XmlBeans.getContextTypeLoader().newInstance(TestCase.Files.type, (XmlOptions)null);
         }

         public static TestCase.Files newInstance(XmlOptions options) {
            return (TestCase.Files)XmlBeans.getContextTypeLoader().newInstance(TestCase.Files.type, options);
         }
   ...
   static class NamelessClass2038084292 {
   }
}
