...
public interface DefinitionsDocument extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DefinitionsDocument.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLTOOLS").resolveHandle("definitionsc7f1doctype");


   DefinitionsDocument.Definitions getDefinitions();

   void setDefinitions(DefinitionsDocument.Definitions var1);
   ...
   public interface Definitions extends XmlObject {
      ...
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DefinitionsDocument.Definitions.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLTOOLS").resolveHandle("definitions05ddelemtype");
      ...
      public static final class Factory {
         ...
         public static DefinitionsDocument.Definitions newInstance() {
            return (DefinitionsDocument.Definitions)XmlBeans.getContextTypeLoader().newInstance(DefinitionsDocument.Definitions.type, (XmlOptions)null);
         }

         public static DefinitionsDocument.Definitions newInstance(XmlOptions options) {
            return (DefinitionsDocument.Definitions)XmlBeans.getContextTypeLoader().newInstance(DefinitionsDocument.Definitions.type, options);
         }
   ...
   static class NamelessClass1325706876 {
   }
}
