...
public class PrototypeFactory {
   ...
   public static Factory prototypeFactory(Object prototype) {
      if(prototype == null) {
         ...
         try {
            Method ex = prototype.getClass().getMethod("clone", (Class[])null);
            return new PrototypeFactory.PrototypeCloneFactory(prototype, ex, (PrototypeFactory.NamelessClass2001581958)null);
            ...
            try {
               ...
               if(prototype instanceof Serializable) {
                  return new PrototypeFactory.PrototypeSerializationFactory((Serializable)prototype, (PrototypeFactory.NamelessClass2001581958)null);
               } else {
   ...
   // $FF: synthetic class
   static class NamelessClass2001581958 {
   }
   ...
   static class PrototypeSerializationFactory implements Factory {
      ...
      public Serializable create() {
         ...
         try {
            ...
            ex.writeObject(this.iPrototype);
      ...
      // $FF: synthetic method
      PrototypeSerializationFactory(Serializable x0, PrototypeFactory.NamelessClass2001581958 x1) {
         this(x0);
      }
   }
   ...
   static class PrototypeCloneFactory implements Factory {
      ...
      // $FF: synthetic method
      PrototypeCloneFactory(Object x0, Method x1, PrototypeFactory.NamelessClass2001581958 x2) {
         this(x0, x1);
      }
   }
}
