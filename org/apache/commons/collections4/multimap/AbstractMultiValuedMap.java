...
public abstract class AbstractMultiValuedMap implements MultiValuedMap {
   ...
   public Collection entries() {
      return this.entryValuesView != null?this.entryValuesView:(this.entryValuesView = new AbstractMultiValuedMap.EntryValues((AbstractMultiValuedMap.NamelessClass193699712)null));
   }
   ...
   public Collection values() {
      ...
      return (Collection)(vs != null?vs:(this.valuesView = new AbstractMultiValuedMap.Values((AbstractMultiValuedMap.NamelessClass193699712)null)));
   }
   ...
   public MultiSet keys() {
      if(this.keysMultiSetView == null) {
         this.keysMultiSetView = UnmodifiableMultiSet.unmodifiableMultiSet(new AbstractMultiValuedMap.KeysMultiSet((AbstractMultiValuedMap.NamelessClass193699712)null));
      }
   ...
   public boolean putAll(Object key, Iterable values) {
      if(values == null) {
         ...
         Collection it1 = (Collection)values;
         return !it1.isEmpty() && this.get(key).addAll(it1);
      } else {
   ...
   public boolean equals(Object obj) {
      return this == obj?true:(obj instanceof MultiValuedMap?this.asMap().equals(((MultiValuedMap)obj).asMap()):false);
   }
   ...
   private class EntryValues extends AbstractCollection {
      ...
      // $FF: synthetic method
      EntryValues(AbstractMultiValuedMap.NamelessClass193699712 x1) {
         this();
      }
   }
   ...
   private class KeysMultiSet extends AbstractMultiSet {
      ...
      protected Iterator createEntrySetIterator() {
         AbstractMultiValuedMap.KeysMultiSet.MapEntryTransformer transformer = new AbstractMultiValuedMap.KeysMultiSet.MapEntryTransformer((AbstractMultiValuedMap.NamelessClass193699712)null);
         return IteratorUtils.transformedIterator(AbstractMultiValuedMap.this.map.entrySet().iterator(), transformer);
      }

      // $FF: synthetic method
      KeysMultiSet(AbstractMultiValuedMap.NamelessClass193699712 x1) {
         this();
      }
      ...
      private final class MapEntryTransformer implements Transformer {
         ...
         // $FF: synthetic method
         MapEntryTransformer(AbstractMultiValuedMap.NamelessClass193699712 x1) {
            this();
         }
      }
   }
   ...
   // $FF: synthetic class
   static class NamelessClass193699712 {
   }
   ...
   private class Values extends AbstractCollection {
      ...
      // $FF: synthetic method
      Values(AbstractMultiValuedMap.NamelessClass193699712 x1) {
         this();
      }
   }
}
