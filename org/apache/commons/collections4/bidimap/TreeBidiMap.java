...
public class TreeBidiMap implements OrderedBidiMap, Serializable {
   ...
   private void doPut(Comparable key, Comparable value) {
      ...
      if(node == null) {
         TreeBidiMap.Node cmp = new TreeBidiMap.Node(key, value);
         this.rootNode[TreeBidiMap.DataElement.KEY.ordinal()] = cmp;
         this.rootNode[TreeBidiMap.DataElement.VALUE.ordinal()] = cmp;
         this.grow();
      } else {
         while(true) {
            int cmp1 = compare(key, node.getKey());
            if(cmp1 == 0) {
   ...
   private boolean doEquals(Object obj, TreeBidiMap.DataElement dataElement) {
      if(obj == this) {
         ...
         if(other.size() != this.size()) {
            ...
            if(this.nodeCount > 0) {
               try {
                  MapIterator ex = this.getMapIterator(dataElement);
   ...
   private MapIterator getMapIterator(TreeBidiMap.DataElement dataElement) {
      switch(TreeBidiMap.NamelessClass59312284.$SwitchMap$org$apache$commons$collections4$bidimap$TreeBidiMap$DataElement[dataElement.ordinal()]) {
      case 1:
   ...
   static enum DataElement {
      ...
      // $FF: synthetic field
      private static final TreeBidiMap.DataElement[] $VALUES = new TreeBidiMap.DataElement[]{KEY, VALUE};


      private DataElement(String var1, int var2, String description) {
   ...
   // $FF: synthetic class
   static class NamelessClass59312284 {

      // $FF: synthetic field
      static final int[] $SwitchMap$org$apache$commons$collections4$bidimap$TreeBidiMap$DataElement = new int[TreeBidiMap.DataElement.values().length];


      static {
         try {
            $SwitchMap$org$apache$commons$collections4$bidimap$TreeBidiMap$DataElement[TreeBidiMap.DataElement.KEY.ordinal()] = 1;
         } catch (NoSuchFieldError var2) {
            ;
         }

         try {
            $SwitchMap$org$apache$commons$collections4$bidimap$TreeBidiMap$DataElement[TreeBidiMap.DataElement.VALUE.ordinal()] = 2;
