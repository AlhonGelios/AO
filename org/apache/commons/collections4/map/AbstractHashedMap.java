...
public class AbstractHashedMap extends AbstractMap implements IterableMap {
   ...
   protected AbstractHashedMap clone() {
      try {
         AbstractHashedMap ex = (AbstractHashedMap)super.clone();
         ex.data = new AbstractHashedMap.HashEntry[this.data.length];
         ex.entrySet = null;
         ex.keySet = null;
         ex.values = null;
         ex.modCount = 0;
         ...
         if(map.size() != this.size()) {
            ...
            try {
               ...
               do {
                  ...
                  } while(value.equals(map.get(ignored)));

                  return false;
               } while(map.get(ignored) == null && map.containsKey(ignored));
   ...
   protected static class EntrySet extends AbstractSet {
      ...
      public boolean contains(Object entry) {
         if(!(entry instanceof Entry)) {
            ...
            Entry e = (Entry)entry;
            AbstractHashedMap.HashEntry match = this.parent.getEntry(e.getKey());
