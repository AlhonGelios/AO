...
public class Flat3Map implements IterableMap, Serializable, Cloneable {
   ...
   public Object put(Object key, Object value) {
      if(this.delegateMap != null) {
         ...
         if(key == null) {
            ...
            case 3:
               if(this.key3 == null) {
                  hashCode = this.value3;
                  this.value3 = value;
                  return hashCode;
               }
            case 2:
               if(this.key2 == null) {
                  hashCode = this.value2;
                  this.value2 = value;
                  return hashCode;
               }
            case 1:
               if(this.key1 == null) {
                  hashCode = this.value1;
                  this.value1 = value;
                  return hashCode;
               }
            }
            ...
            switch(this.size) {
            case 3:
               if(this.hash3 == hashCode1 && key.equals(this.key3)) {
                  old = this.value3;
                  this.value3 = value;
                  return old;
               }
            case 2:
               if(this.hash2 == hashCode1 && key.equals(this.key2)) {
                  old = this.value2;
                  this.value2 = value;
                  return old;
               }
            case 1:
               if(this.hash1 == hashCode1 && key.equals(this.key1)) {
                  old = this.value1;
                  this.value1 = value;
                  return old;
               }
   ...
   public MapIterator mapIterator() {
      return (MapIterator)(this.delegateMap != null?this.delegateMap.mapIterator():(this.size == 0?EmptyMapIterator.emptyMapIterator():new Flat3Map.FlatMapIterator(this)));
   }
   ...
   public Flat3Map clone() {
      try {
         Flat3Map ex = (Flat3Map)super.clone();
         if(ex.delegateMap != null) {
            ex.delegateMap = ex.delegateMap.clone();
         }
   ...
   static class Values extends AbstractCollection {
      ...
      public Iterator iterator() {
         return (Iterator)(this.parent.delegateMap != null?this.parent.delegateMap.values().iterator():(this.parent.size() == 0?EmptyIterator.emptyIterator():new Flat3Map.ValuesIterator(this.parent)));
      }
   }
   ...
   static class KeySet extends AbstractSet {
      ...
      public Iterator iterator() {
         return (Iterator)(this.parent.delegateMap != null?this.parent.delegateMap.keySet().iterator():(this.parent.size() == 0?EmptyIterator.emptyIterator():new Flat3Map.KeySetIterator(this.parent)));
      }
   }
   ...
   static class EntrySet extends AbstractSet {
      ...
      public Iterator iterator() {
         return (Iterator)(this.parent.delegateMap != null?this.parent.delegateMap.entrySet().iterator():(this.parent.size() == 0?EmptyIterator.emptyIterator():new Flat3Map.EntrySetIterator(this.parent)));
      }
   }
