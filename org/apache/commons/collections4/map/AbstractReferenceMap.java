...
public abstract class AbstractReferenceMap extends AbstractHashedMap {
   ...
   static class ReferenceMapIterator extends AbstractReferenceMap.ReferenceBaseIterator implements MapIterator {
      ...
      public Object getKey() {
         AbstractReferenceMap.ReferenceEntry current = this.currentEntry();
         if(current == null) {
   ...
   public static enum ReferenceStrength {
      ...
      // $FF: synthetic field
      private static final AbstractReferenceMap.ReferenceStrength[] $VALUES = new AbstractReferenceMap.ReferenceStrength[]{HARD, SOFT, WEAK};
      ...
      private ReferenceStrength(String var1, int var2, int value) {
         this.value = value;
      }
   ...
   protected static class ReferenceEntry extends AbstractHashedMap.HashEntry {
      ...
      public boolean equals(Object obj) {
         if(obj == this) {
            ...
            return entryKey != null && entryValue != null?this.parent.isEqualKey(entryKey, this.key) && this.parent.isEqualValue(entryValue, this.getValue()):false;
         }
      }
