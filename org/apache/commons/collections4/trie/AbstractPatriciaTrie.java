...
abstract class AbstractPatriciaTrie extends AbstractBitwiseTrie {
   ...
   public Entry select(Object key) {
      int lengthInBits = this.lengthInBits(key);
      AbstractPatriciaTrie.Reference reference = new AbstractPatriciaTrie.Reference((AbstractPatriciaTrie.NamelessClass335829080)null);
   ...
   public Set entrySet() {
      if(this.entrySet == null) {
         this.entrySet = new AbstractPatriciaTrie.EntrySet((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
   ...
   public Set keySet() {
      if(this.keySet == null) {
         this.keySet = new AbstractPatriciaTrie.KeySet((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
   ...
   public Collection values() {
      if(this.values == null) {
         this.values = new AbstractPatriciaTrie.Values((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
   ...
   public OrderedMapIterator mapIterator() {
      return new AbstractPatriciaTrie.TrieMapIterator((AbstractPatriciaTrie.NamelessClass335829080)null);
   }
   ...
   private SortedMap getPrefixMapByBits(Object key, int offsetInBits, int lengthInBits) {
      ...
      if(offsetLength > this.lengthInBits(key)) {
         ...
         return (SortedMap)(offsetLength == 0?this:new AbstractPatriciaTrie.PrefixRangeMap(key, offsetInBits, lengthInBits, (AbstractPatriciaTrie.NamelessClass335829080)null));
      }
   }
   ...
   private class RangeEntrySet extends AbstractSet {
      ...
      public Iterator iterator() {
         ...
         return new AbstractPatriciaTrie.RangeEntrySet.EntryIterator(first, last, (AbstractPatriciaTrie.NamelessClass335829080)null);
      }
      ...
      private final class EntryIterator extends AbstractPatriciaTrie.TrieIterator {
         ...
         // $FF: synthetic method
         EntryIterator(AbstractPatriciaTrie.TrieEntry x1, AbstractPatriciaTrie.TrieEntry x2, AbstractPatriciaTrie.NamelessClass335829080 x3) {
            this(x1, x2);
         }
      }
   }
   ...
   private class KeySet extends AbstractSet {
      ...
      public Iterator iterator() {
         return new AbstractPatriciaTrie.KeySet.KeyIterator((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
      ...
      // $FF: synthetic method
      KeySet(AbstractPatriciaTrie.NamelessClass335829080 x1) {
         this();
      }
      ...
      private class KeyIterator extends AbstractPatriciaTrie.TrieIterator {
         ...
         // $FF: synthetic method
         KeyIterator(AbstractPatriciaTrie.NamelessClass335829080 x1) {
            this();
         }
      }
   }
   ...
   private static class Reference {
      ...
      // $FF: synthetic method
      Reference(AbstractPatriciaTrie.NamelessClass335829080 x0) {
         this();
      }
   }
   ...
   private class RangeEntryMap extends AbstractPatriciaTrie.RangeMap {
      ...
      protected RangeEntryMap(Object fromKey, boolean fromInclusive, Object toKey, boolean toInclusive) {
         super((AbstractPatriciaTrie.NamelessClass335829080)null);
      ...
      public Object firstKey() {
         AbstractPatriciaTrie.TrieEntry e = null;
   ...
   private class TrieMapIterator extends AbstractPatriciaTrie.TrieIterator implements OrderedMapIterator {
      ...
      // $FF: synthetic method
      TrieMapIterator(AbstractPatriciaTrie.NamelessClass335829080 x1) {
         this();
      }
   }

   // $FF: synthetic class
   static class NamelessClass335829080 {
   }
   ...
   private class Values extends AbstractCollection {
      ...
      public Iterator iterator() {
         return new AbstractPatriciaTrie.Values.ValueIterator((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
      ...
      // $FF: synthetic method
      Values(AbstractPatriciaTrie.NamelessClass335829080 x1) {
         this();
      }
      ...
      private class ValueIterator extends AbstractPatriciaTrie.TrieIterator {
         ...
         // $FF: synthetic method
         ValueIterator(AbstractPatriciaTrie.NamelessClass335829080 x1) {
            this();
         }
      }
   }
   ...
   private class EntrySet extends AbstractSet {
      ...
      public Iterator iterator() {
         return new AbstractPatriciaTrie.EntrySet.EntryIterator((AbstractPatriciaTrie.NamelessClass335829080)null);
      }
      ...
      // $FF: synthetic method
      EntrySet(AbstractPatriciaTrie.NamelessClass335829080 x1) {
         this();
      }
      ...
      private class EntryIterator extends AbstractPatriciaTrie.TrieIterator {
         ...
         // $FF: synthetic method
         EntryIterator(AbstractPatriciaTrie.NamelessClass335829080 x1) {
            this();
         }
      }
   }
   ...
   private abstract class RangeMap extends AbstractMap implements SortedMap {
      ...
      // $FF: synthetic method
      RangeMap(AbstractPatriciaTrie.NamelessClass335829080 x1) {
         this();
      }
   }
   ...
   private class PrefixRangeMap extends AbstractPatriciaTrie.RangeMap {
      ...
      private int fixup() {
         if(this.size == -1 || AbstractPatriciaTrie.this.modCount != this.expectedModCount) {
            ...
            if(this.fromKey != null) {
               AbstractPatriciaTrie.TrieEntry prior = AbstractPatriciaTrie.this.previousEntry((AbstractPatriciaTrie.TrieEntry)entry);
               this.fromKey = prior == null?null:prior.getKey();
            }

            for(this.toKey = this.fromKey; it.hasNext(); entry = (Entry)it.next()) {
               ++this.size;
            }

            this.toKey = entry == null?null:entry.getKey();
            if(this.toKey != null) {
               AbstractPatriciaTrie.TrieEntry entry1 = AbstractPatriciaTrie.this.nextEntry((AbstractPatriciaTrie.TrieEntry)entry);
               this.toKey = entry1 == null?null:entry1.getKey();
            }
      ...
      // $FF: synthetic method
      PrefixRangeMap(Object x1, int x2, int x3, AbstractPatriciaTrie.NamelessClass335829080 x4) {
         this(x1, x2, x3);
      }
   }
}
