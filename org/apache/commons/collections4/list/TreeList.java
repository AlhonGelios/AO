...
public class TreeList extends AbstractList {
   ...
   public TreeList(Collection coll) {
      if(!coll.isEmpty()) {
         this.root = new TreeList.AVLNode(coll, (TreeList.NamelessClass2020094668)null);
         this.size = coll.size();
      }
   ...
   public void add(int index, Object obj) {
      ...
      if(this.root == null) {
         this.root = new TreeList.AVLNode(index, obj, (TreeList.AVLNode)null, (TreeList.AVLNode)null, (TreeList.NamelessClass2020094668)null);
      } else {
   ...
   public boolean addAll(Collection c) {
      if(c.isEmpty()) {
         ...
         TreeList.AVLNode cTree = new TreeList.AVLNode(c, (TreeList.NamelessClass2020094668)null);
   ...
   // $FF: synthetic class
   static class NamelessClass2020094668 {
   }
   ...
   static class AVLNode {
      ...
      private TreeList.AVLNode addAll(TreeList.AVLNode otherTree, int currentSize) {
         ...
         if(otherTree.height > this.height) {
            TreeList.AVLNode var11 = this.removeMax();
            ArrayDeque var12 = new ArrayDeque();
            TreeList.AVLNode var13 = otherTree;
            sParentAbsolutePosition = otherTree.relativePosition + currentSize;
            int var14 = 0;

            while(var13 != null && var13.height > this.getHeight(var11)) {
               var14 = sParentAbsolutePosition;
               var12.push(var13);
               var13 = var13.left;
               if(var13 != null) {
                  sParentAbsolutePosition += var13.relativePosition;
               }
            }

            maxNode.setLeft(var11, (TreeList.AVLNode)null);
            maxNode.setRight(var13, otherTreeMin);
            if(var11 != null) {
               var11.max().setRight((TreeList.AVLNode)null, maxNode);
               var11.relativePosition -= currentSize - 1;
            }

            if(var13 != null) {
               var13.min().setLeft((TreeList.AVLNode)null, maxNode);
               var13.relativePosition = sParentAbsolutePosition - currentSize + 1;
            }

            maxNode.relativePosition = currentSize - 1 - var14;
            otherTree.relativePosition += currentSize;

            TreeList.AVLNode sAncestor1;
            for(var13 = maxNode; !var12.isEmpty(); var13 = sAncestor1.balance()) {
               sAncestor1 = (TreeList.AVLNode)var12.pop();
               sAncestor1.setLeft(var13, (TreeList.AVLNode)null);
            }

            return var13;
         } else {
            otherTree = otherTree.removeMin();
            ArrayDeque sAncestors = new ArrayDeque();
      ...
      // $FF: synthetic method
      AVLNode(Collection x0, TreeList.NamelessClass2020094668 x1) {
         this(x0);
      }

      // $FF: synthetic method
      AVLNode(int x0, Object x1, TreeList.AVLNode x2, TreeList.AVLNode x3, TreeList.NamelessClass2020094668 x4) {
         this(x0, x1, x2, x3);
      }
   }
