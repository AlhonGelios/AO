...
public abstract class AbstractLinkedList implements List {
   ...
   public Object[] toArray(Object[] array) {
      if(array.length < this.size) {
         Class i = array.getClass().getComponentType();
         array = (Object[])((Object[])Array.newInstance(i, this.size));
      }

      int var4 = 0;

      for(AbstractLinkedList.Node node = this.header.next; node != this.header; ++var4) {
         array[var4] = node.getValue();
         node = node.next;
      }
