...
public abstract class AbstractMapMultiSet extends AbstractMultiSet {
   ...
   public Object[] toArray(Object[] array) {
      ...
      if(array.length < size) {
         Object[] i = (Object[])((Object[])Array.newInstance(array.getClass().getComponentType(), size));
         array = i;
      }
   ...
   // $FF: synthetic method
   static int access$210(AbstractMapMultiSet x0) {
      return x0.size--;
   }
   ...
   protected static class MutableInteger {
      ...
      public boolean equals(Object obj) {
         return !(obj instanceof AbstractMapMultiSet.MutableInteger)?false:((AbstractMapMultiSet.MutableInteger)obj).value == this.value;
      }
