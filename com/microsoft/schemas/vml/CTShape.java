...
public interface CTShape extends XmlObject {
   ...
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CTShape.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sF1327CCA741569E70F9CA8C9AF9B44B2").resolveHandle("ctshape5cb5type");
   ...
   CTInk getInkArray(int var1);

   int sizeOfInkArray();

   void setInkArray(CTInk[] var1);

   void setInkArray(int var1, CTInk var2);

   CTInk insertNewInk(int var1);

   CTInk addNewInk();

   void removeInk(int var1);

   List getIscommentList();

   CTEmpty[] getIscommentArray();

   CTEmpty getIscommentArray(int var1);

   int sizeOfIscommentArray();

   void setIscommentArray(CTEmpty[] var1);

   void setIscommentArray(int var1, CTEmpty var2);

   CTEmpty insertNewIscomment(int var1);

   CTEmpty addNewIscomment();

   void removeIscomment(int var1);
   ...
   void setGfxdata(byte[] var1);

   void xsetGfxdata(XmlBase64Binary var1);
   ...
   void setEquationxml(String var1);

   void xsetEquationxml(XmlString var1);
